...
void main() {
	...
	`}function Nv(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const c=a.mapping,l=c===Wc||c===Xc,u=c===tr||c===nr;if(l||u){let d=e.get(a);const h=d!==void 0?d.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==h)return t===null&&(t=new fh(i)),d=l?t.fromEquirectangular(a,d):t.fromCubemap(a,d),d.texture.pmremVersion=a.pmremVersion,e.set(a,d),d.texture;if(d!==void 0)return d.texture;{const p=a.image;return l&&p&&p.height>0||u&&p&&s(p)?(t===null&&(t=new fh(i)),d=l?t.fromEquirectangular(a):t.fromCubemap(a),d.texture.pmremVersion=a.pmremVersion,e.set(a,d),a.addEventListener("dispose",r),d.texture):null}}}return a}function s(a){let c=0;const l=6;for(let u=0;u<l;u++)a[u]!==void 0&&c++;return c===l}function r(a){const c=a.target;c.removeEventListener("dispose",r);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function Av(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&eu("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function wv(i,e,t,n){const s={},r=new WeakMap;function o(d){const h=d.target;h.index!==null&&e.remove(h.index);for(const g in h.attributes)e.remove(h.attributes[g]);for(const g in h.morphAttributes){const _=h.morphAttributes[g];for(let m=0,f=_.length;m<f;m++)e.remove(_[m])}h.removeEventListener("dispose",o),delete s[h.id];const p=r.get(h);p&&(e.remove(p),r.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function a(d,h){return s[h.id]===!0||(h.addEventListener("dispose",o),s[h.id]=!0,t.memory.geometries++),h}function c(d){const h=d.attributes;for(const g in h)e.update(h[g],i.ARRAY_BUFFER);const p=d.morphAttributes;for(const g in p){const _=p[g];for(let m=0,f=_.length;m<f;m++)e.update(_[m],i.ARRAY_BUFFER)}}function l(d){const h=[],p=d.index,g=d.attributes.position;let _=0;if(p!==null){const E=p.array;_=p.version;for(let v=0,N=E.length;v<N;v+=3){const D=E[v+0],b=E[v+1],A=E[v+2];h.push(D,b,b,A,A,D)}}else if(g!==void 0){const E=g.array;_=g.version;for(let v=0,N=E.length/3-1;v<N;v+=3){const D=v+0,b=v+1,A=v+2;h.push(D,b,b,A,A,D)}}else return;const m=new(af(h)?df:hf)(h,1);m.version=_;const f=r.get(d);f&&e.remove(f),r.set(d,m)}function u(d){const h=r.get(d);if(h){const p=d.index;p!==null&&h.version<p.version&&l(d)}else l(d);return r.get(d)}return{get:a,update:c,getWireframeAttribute:u}}function bv(i,e,t){let n;function s(h){n=h}let r,o;function a(h){r=h.type,o=h.bytesPerElement}function c(h,p){i.drawElements(n,p,r,h*o),t.update(p,n,1)}function l(h,p,g){g!==0&&(i.drawElementsInstanced(n,p,r,h*o,g),t.update(p,n,g))}function u(h,p,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,r,h,0,g);let m=0;for(let f=0;f<g;f++)m+=p[f];t.update(m,n,1)}function d(h,p,g,_){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let f=0;f<h.length;f++)l(h[f]/o,p[f],_[f]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,r,h,0,_,0,g);let f=0;for(let E=0;E<g;E++)f+=p[E];for(let E=0;E<_.length;E++)t.update(f,n,_[E])}}this.setMode=s,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=u,this.renderMultiDrawInstances=d}function Rv(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(r/3);break;case i.LINES:t.lines+=a*(r/2);break;case i.LINE_STRIP:t.lines+=a*(r-1);break;case i.LINE_LOOP:t.lines+=a*r;break;case i.POINTS:t.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function Cv(i,e,t){const n=new WeakMap,s=new nt;function r(o,a,c){const l=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,d=u!==void 0?u.length:0;let h=n.get(a);if(h===void 0||h.count!==d){let M=function(){P.dispose(),n.delete(a),a.removeEventListener("dispose",M)};var p=M;h!==void 0&&h.texture.dispose();const g=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,f=a.morphAttributes.position||[],E=a.morphAttributes.normal||[],v=a.morphAttributes.color||[];let N=0;g===!0&&(N=1),_===!0&&(N=2),m===!0&&(N=3);let D=a.attributes.position.count*N,b=1;D>e.maxTextureSize&&(b=Math.ceil(D/e.maxTextureSize),D=e.maxTextureSize);const A=new Float32Array(D*b*4*d),P=new tu(A,D,b,d);P.type=ai,P.needsUpdate=!0;const T=N*4;for(let C=0;C<d;C++){const G=f[C],H=E[C],J=v[C],ee=D*b*4*C;for(let j=0;j<G.count;j++){const ne=j*T;g===!0&&(s.fromBufferAttribute(G,j),A[ee+ne+0]=s.x,A[ee+ne+1]=s.y,A[ee+ne+2]=s.z,A[ee+ne+3]=0),_===!0&&(s.fromBufferAttribute(H,j),A[ee+ne+4]=s.x,A[ee+ne+5]=s.y,A[ee+ne+6]=s.z,A[ee+ne+7]=0),m===!0&&(s.fromBufferAttribute(J,j),A[ee+ne+8]=s.x,A[ee+ne+9]=s.y,A[ee+ne+10]=s.z,A[ee+ne+11]=J.itemSize===4?s.w:1)}}h={count:d,texture:P,size:new ve(D,b)},n.set(a,h),a.addEventListener("dispose",M)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let g=0;for(let m=0;m<l.length;m++)g+=l[m];const _=a.morphTargetsRelative?1:1-g;c.getUniforms().setValue(i,"morphTargetBaseInfluence",_),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",h.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",h.size)}return{update:r}}function Lv(i,e,t,n){let s=new WeakMap;function r(c){const l=n.render.frame,u=c.geometry,d=e.get(c,u);if(s.get(d)!==l&&(e.update(d),s.set(d,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),s.get(c)!==l&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){const h=c.skeleton;s.get(h)!==l&&(h.update(),s.set(h,l))}return d}function o(){s=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:r,dispose:o}}class qr extends on{constructor(e,t,n,s,r,o,a,c,l,u=Ys){if(u!==Ys&&u!==sr)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===Ys&&(n=qi),n===void 0&&u===sr&&(n=ir),super(null,s,r,o,a,c,u,n,l),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:sn,this.minFilter=c!==void 0?c:sn,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const _f=new on,_h=new qr(1,1),xf=new tu,vf=new __,yf=new mf,xh=[],vh=[],yh=new Float32Array(16),Mh=new Float32Array(9),Sh=new Float32Array(4);function dr(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=xh[s];if(r===void 0&&(r=new Float32Array(s),xh[s]=r),e!==0){n.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(r,a)}return r}function kt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Gt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function va(i,e){let t=vh[e];t===void 0&&(t=new Int32Array(e),vh[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Pv(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Iv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(kt(t,e))return;i.uniform2fv(this.addr,e),Gt(t,e)}}function Dv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(kt(t,e))return;i.uniform3fv(this.addr,e),Gt(t,e)}}function Uv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(kt(t,e))return;i.uniform4fv(this.addr,e),Gt(t,e)}}function Ov(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(kt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Gt(t,e)}else{if(kt(t,n))return;Sh.set(n),i.uniformMatrix2fv(this.addr,!1,Sh),Gt(t,n)}}function Fv(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(kt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Gt(t,e)}else{if(kt(t,n))return;Mh.set(n),i.uniformMatrix3fv(this.addr,!1,Mh),Gt(t,n)}}function zv(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(kt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Gt(t,e)}else{if(kt(t,n))return;yh.set(n),i.uniformMatrix4fv(this.addr,!1,yh),Gt(t,n)}}function Bv(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Vv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(kt(t,e))return;i.uniform2iv(this.addr,e),Gt(t,e)}}function Hv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(kt(t,e))return;i.uniform3iv(this.addr,e),Gt(t,e)}}function kv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(kt(t,e))return;i.uniform4iv(this.addr,e),Gt(t,e)}}function Gv(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Wv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(kt(t,e))return;i.uniform2uiv(this.addr,e),Gt(t,e)}}function Xv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(kt(t,e))return;i.uniform3uiv(this.addr,e),Gt(t,e)}}function qv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(kt(t,e))return;i.uniform4uiv(this.addr,e),Gt(t,e)}}function Yv(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(_h.compareFunction=of,r=_h):r=_f,t.setTexture2D(e||r,s)}function $v(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||vf,s)}function jv(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||yf,s)}function Kv(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||xf,s)}function Zv(i){switch(i){case 5126:return Pv;case 35664:return Iv;case 35665:return Dv;case 35666:return Uv;case 35674:return Ov;case 35675:return Fv;case 35676:return zv;case 5124:case 35670:return Bv;case 35667:case 35671:return Vv;case 35668:case 35672:return Hv;case 35669:case 35673:return kv;case 5125:return Gv;case 36294:return Wv;case 36295:return Xv;case 36296:return qv;case 35678:case 36198:case 36298:case 36306:case 35682:return Yv;case 35679:case 36299:case 36307:return $v;case 35680:case 36300:case 36308:case 36293:return jv;case 36289:case 36303:case 36311:case 36292:return Kv}}function Jv(i,e){i.uniform1fv(this.addr,e)}function Qv(i,e){const t=dr(e,this.size,2);i.uniform2fv(this.addr,t)}function ey(i,e){const t=dr(e,this.size,3);i.uniform3fv(this.addr,t)}function ty(i,e){const t=dr(e,this.size,4);i.uniform4fv(this.addr,t)}function ny(i,e){const t=dr(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function iy(i,e){const t=dr(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function sy(i,e){const t=dr(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function ry(i,e){i.uniform1iv(this.addr,e)}function oy(i,e){i.uniform2iv(this.addr,e)}function ay(i,e){i.uniform3iv(this.addr,e)}function cy(i,e){i.uniform4iv(this.addr,e)}function ly(i,e){i.uniform1uiv(this.addr,e)}function uy(i,e){i.uniform2uiv(this.addr,e)}function hy(i,e){i.uniform3uiv(this.addr,e)}function dy(i,e){i.uniform4uiv(this.addr,e)}function fy(i,e,t){const n=this.cache,s=e.length,r=va(t,s);kt(n,r)||(i.uniform1iv(this.addr,r),Gt(n,r));for(let o=0;o!==s;++o)t.setTexture2D(e[o]||_f,r[o])}function py(i,e,t){const n=this.cache,s=e.length,r=va(t,s);kt(n,r)||(i.uniform1iv(this.addr,r),Gt(n,r));for(let o=0;o!==s;++o)t.setTexture3D(e[o]||vf,r[o])}function my(i,e,t){const n=this.cache,s=e.length,r=va(t,s);kt(n,r)||(i.uniform1iv(this.addr,r),Gt(n,r));for(let o=0;o!==s;++o)t.setTextureCube(e[o]||yf,r[o])}function gy(i,e,t){const n=this.cache,s=e.length,r=va(t,s);kt(n,r)||(i.uniform1iv(this.addr,r),Gt(n,r));for(let o=0;o!==s;++o)t.setTexture2DArray(e[o]||xf,r[o])}function _y(i){switch(i){case 5126:return Jv;case 35664:return Qv;case 35665:return ey;case 35666:return ty;case 35674:return ny;case 35675:return iy;case 35676:return sy;case 5124:case 35670:return ry;case 35667:case 35671:return oy;case 35668:case 35672:return ay;case 35669:case 35673:return cy;case 5125:return ly;case 36294:return uy;case 36295:return hy;case 36296:return dy;case 35678:case 36198:case 36298:case 36306:case 35682:return fy;case 35679:case 36299:case 36307:return py;case 35680:case 36300:case 36308:case 36293:return my;case 36289:case 36303:case 36311:case 36292:return gy}}class xy{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Zv(t.type)}}class vy{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=_y(t.type)}}class yy{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(e,t[a.id],n)}}}const pc=/(\w+)(\])?(\[|\.)?/g;function Th(i,e){i.seq.push(e),i.map[e.id]=e}function My(i,e,t){const n=i.name,s=n.length;for(pc.lastIndex=0;;){const r=pc.exec(n),o=pc.lastIndex;let a=r[1];const c=r[2]==="]",l=r[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===s){Th(t,l===void 0?new xy(a,i,e):new vy(a,i,e));break}else{let d=t.map[a];d===void 0&&(d=new yy(a),Th(t,d)),t=d}}}class Ho{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=e.getActiveUniform(t,s),o=e.getUniformLocation(t,r.name);My(r,o,this)}}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,o=t.length;r!==o;++r){const a=t[r],c=n[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const o=e[s];o.id in t&&n.push(o)}return n}}function Eh(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const Sy=37297;let Ty=0;function Ey(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=s;o<r;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function Ny(i){const e=mt.getPrimaries(mt.workingColorSpace),t=mt.getPrimaries(i);let n;switch(e===t?n="":e===Ko&&t===jo?n="LinearDisplayP3ToLinearSRGB":e===jo&&t===Ko&&(n="LinearSRGBToLinearDisplayP3"),i){case Qn:case ma:return[n,"LinearTransferOETF"];case Xn:case Zl:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function Nh(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=i.getShaderInfoLog(e).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const o=parseInt(r[1]);return t.toUpperCase()+`

`+s+`

`+Ey(i.getShaderSource(e),o)}else return s}function Ay(i,e){const t=Ny(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function wy(i,e){let t;switch(e){case Vd:t="Linear";break;case Hd:t="Reinhard";break;case kd:t="OptimizedCineon";break;case Gd:t="ACESFilmic";break;case Wd:t="AgX";break;case Xd:t="Neutral";break;case Bg:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function by(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Lr).join(`
`)}function Ry(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Cy(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function Lr(i){return i!==""}function Ah(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function wh(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Ly=/^[ \t]*#include +<([\w\d./]+)>/gm;function yl(i){return i.replace(Ly,Iy)}const Py=new Map;function Iy(i,e){let t=Ke[e];if(t===void 0){const n=Py.get(e);if(n!==void 0)t=Ke[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return yl(t)}const Dy=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function bh(i){return i.replace(Dy,Uy)}function Uy(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Rh(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function Oy(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Bd?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===hg?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===xi&&(e="SHADOWMAP_TYPE_VSM"),e}function Fy(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case tr:case nr:e="ENVMAP_TYPE_CUBE";break;case fa:e="ENVMAP_TYPE_CUBE_UV";break}return e}function zy(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case nr:e="ENVMAP_MODE_REFRACTION";break}return e}function By(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case da:e="ENVMAP_BLENDING_MULTIPLY";break;case Fg:e="ENVMAP_BLENDING_MIX";break;case zg:e="ENVMAP_BLENDING_ADD";break}return e}function Vy(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Hy(i,e,t,n){const s=i.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=Oy(t),l=Fy(t),u=zy(t),d=By(t),h=Vy(t),p=by(t),g=Ry(r),_=s.createProgram();let m,f,E=t.glslVersion?"#version "+t.glslVersion+`
...
`);return e.format(l,n,t)}}const Un=B(bu);O("cond",Un);te("CondNode",bu);const od=Z(1),Il=Z(-2),bo=Z(.8),Ec=Z(-1),Ro=Z(.4),Nc=Z(2),Co=Z(.305),Ac=Z(3),ad=Z(.21),FE=Z(4),cd=Z(4),zE=Z(16),BE=he(([i])=>{const e=q(ii(i)).toVar(),t=Z(-1).toVar();return Lt(e.x.greaterThan(e.z),()=>{Lt(e.x.greaterThan(e.y),()=>{t.assign(Un(i.x.greaterThan(0),0,3))}).else(()=>{t.assign(Un(i.y.greaterThan(0),1,4))})}).else(()=>{Lt(e.z.greaterThan(e.y),()=>{t.assign(Un(i.z.greaterThan(0),2,5))}).else(()=>{t.assign(Un(i.y.greaterThan(0),1,4))})}),t}).setLayout({name:"getFace",type:"float",inputs:[{name:"direction",type:"vec3"}]}),VE=he(([i,e])=>{const t=se().toVar();return Lt(e.equal(0),()=>{t.assign(se(i.z,i.y).div(ii(i.x)))}).elseif(e.equal(1),()=>{t.assign(se(i.x.negate(),i.z.negate()).div(ii(i.y)))}).elseif(e.equal(2),()=>{t.assign(se(i.x.negate(),i.y).div(ii(i.z)))}).elseif(e.equal(3),()=>{t.assign(se(i.z.negate(),i.y).div(ii(i.x)))}).elseif(e.equal(4),()=>{t.assign(se(i.x.negate(),i.z).div(ii(i.y)))}).else(()=>{t.assign(se(i.x,i.y).div(ii(i.z)))}),ft(.5,t.add(1))}).setLayout({name:"getUV",type:"vec2",inputs:[{name:"direction",type:"vec3"},{name:"face",type:"float"}]}),HE=he(([i])=>{const e=Z(0).toVar();return Lt(i.greaterThanEqual(bo),()=>{e.assign(od.sub(i).mul(Ec.sub(Il)).div(od.sub(bo)).add(Il))}).elseif(i.greaterThanEqual(Ro),()=>{e.assign(bo.sub(i).mul(Nc.sub(Ec)).div(bo.sub(Ro)).add(Ec))}).elseif(i.greaterThanEqual(Co),()=>{e.assign(Ro.sub(i).mul(Ac.sub(Nc)).div(Ro.sub(Co)).add(Nc))}).elseif(i.greaterThanEqual(ad),()=>{e.assign(Co.sub(i).mul(FE.sub(Ac)).div(Co.sub(ad)).add(Ac))}).else(()=>{e.assign(Z(-2).mul(Ra(ft(1.16,i))))}),e}).setLayout({name:"roughnessToMip",type:"float",inputs:[{name:"roughness",type:"float"}]});he(([i,e])=>{const t=i.toVar();t.assign(ft(2,t).sub(1));const n=q(t,1).toVar();return Lt(e.equal(0),()=>{n.assign(n.zyx)}).elseif(e.equal(1),()=>{n.assign(n.xzy),n.xz.mulAssign(-1)}).elseif(e.equal(2),()=>{n.x.mulAssign(-1)}).elseif(e.equal(3),()=>{n.assign(n.zyx),n.xz.mulAssign(-1)}).elseif(e.equal(4),()=>{n.assign(n.xzy),n.xy.mulAssign(-1)}).elseif(e.equal(5),()=>{n.z.mulAssign(-1)}),n}).setLayout({name:"getDirection",type:"vec3",inputs:[{name:"uv",type:"vec2"},{name:"face",type:"float"}]});const kE=he(([i,e,t,n,s,r])=>{const o=Z(t),a=q(e),c=ps(HE(o),Il,r),l=La(c),u=Ca(c),d=q(Dl(i,a,u,n,s,r)).toVar();return Lt(l.notEqual(0),()=>{const h=q(Dl(i,a,u.add(1),n,s,r)).toVar();d.assign(Ft(d,h,l))}),d}),Dl=he(([i,e,t,n,s,r])=>{const o=Z(t).toVar(),a=q(e),c=Z(BE(a)).toVar(),l=Z(fn(cd.sub(o),0)).toVar();o.assign(fn(o,cd));const u=Z(wl(o)).toVar(),d=se(VE(a,c).mul(u.sub(2)).add(1)).toVar();return Lt(c.greaterThan(2),()=>{d.y.addAssign(u),c.subAssign(3)}),d.x.addAssign(c.mul(u)),d.x.addAssign(l.mul(ft(3,zE))),d.y.addAssign(ft(4,wl(r).sub(u))),d.x.mulAssign(n),d.y.mulAssign(s),i.uv(d).grad(se(),se())}),wc=he(({envMap:i,mipInt:e,outputDirection:t,theta:n,axis:s,CUBEUV_TEXEL_WIDTH:r,CUBEUV_TEXEL_HEIGHT:o,CUBEUV_MAX_MIP:a})=>{const c=ni(n),l=t.mul(c).add(s.cross(t).mul(Rn(n))).add(s.mul(s.dot(t).mul(c.oneMinus())));return Dl(i,l,e,r,o,a)});he(({n:i,latitudinal:e,poleAxis:t,outputDirection:n,weights:s,samples:r,dTheta:o,mipInt:a,envMap:c,CUBEUV_TEXEL_WIDTH:l,CUBEUV_TEXEL_HEIGHT:u,CUBEUV_MAX_MIP:d})=>{const h=q(Un(e,t,np(t,n))).toVar();Lt(Jf(h.equals(q(0))),()=>{h.assign(q(n.z,0,n.x.negate()))}),h.assign(zr(h));const p=q().toVar();return p.addAssign(s.element(Vt(0)).mul(wc({theta:0,axis:h,outputDirection:n,mipInt:a,envMap:c,CUBEUV_TEXEL_WIDTH:l,CUBEUV_TEXEL_HEIGHT:u,CUBEUV_MAX_MIP:d}))),Kn({start:Vt(1),end:i},({i:g})=>{Lt(g.greaterThanEqual(r),()=>{Np()});const _=Z(o.mul(Z(g))).toVar();p.addAssign(s.element(g).mul(wc({theta:_.mul(-1),axis:h,outputDirection:n,mipInt:a,envMap:c,CUBEUV_TEXEL_WIDTH:l,CUBEUV_TEXEL_HEIGHT:u,CUBEUV_MAX_MIP:d}))),p.addAssign(s.element(g).mul(wc({theta:_,axis:h,outputDirection:n,mipInt:a,envMap:c,CUBEUV_TEXEL_WIDTH:l,CUBEUV_TEXEL_HEIGHT:u,CUBEUV_MAX_MIP:d})))}),Me(p,1)});let la=null;const ld=new WeakMap;function GE(i){const e=Math.log2(i)-2,t=1/i;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:t,maxMip:e}}function WE(i){let e=ld.get(i);if((e!==void 0?e.pmremVersion:-1)!==i.pmremVersion){if(i.isCubeTexture){if(i.source.data.some(n=>n===void 0))throw new Error("PMREMNode: Undefined texture in CubeTexture. Use onLoad callback or async loader");e=la.fromCubemap(i,e)}else{if(i.image===void 0)throw new Error("PMREMNode: Undefined image in Texture. Use onLoad callback or async loader");e=la.fromEquirectangular(i,e)}e.pmremVersion=i.pmremVersion,ld.set(i,e)}return e.texture}class Pp extends ct{constructor(e,t=null,n=null){super("vec3"),this._value=e,this._pmrem=null,this.uvNode=t,this.levelNode=n,this._generator=null,this._texture=Kt(null),this._width=ze(0),this._height=ze(0),this._maxMip=ze(0),this.updateBeforeType=st.RENDER}set value(e){this._value=e,this._pmrem=null}get value(){return this._value}updateFromTexture(e){const t=GE(e.image.height);this._texture.value=e,this._width.value=t.texelWidth,this._height.value=t.texelHeight,this._maxMip.value=t.maxMip}updateBefore(){let e=this._pmrem;const t=e?e.pmremVersion:-1,n=this._value;t!==n.pmremVersion&&(n.isPMREMTexture===!0?e=n:e=WE(n),this._pmrem=e,this.updateFromTexture(e))}setup(e){la===null&&(la=e.createPMREMGenerator()),this.updateBefore(e);let t=this.uvNode;t===null&&e.context.getUV&&(t=e.context.getUV(this));const n=this.value;e.renderer.coordinateSystem===jn&&n.isPMREMTexture!==!0&&n.isRenderTargetTexture===!0&&(t=q(t.x.negate(),t.yz));let s=this.levelNode;return s===null&&e.context.getTextureLevel&&(s=e.context.getTextureLevel(this)),kE(this._texture,t,s,this._width,this._height,this._maxMip)}}const XE=B(Pp);te("PMREMNode",Pp);const ud=new WeakMap;class Ip extends Yr{constructor(e=null){super(),this.envNode=e}setup(e){let t=this.envNode;if(t.isTextureNode){let p=ud.get(t.value);p===void 0&&(p=XE(t.value),ud.set(t.value,p)),t=p}const{material:n}=e,r=n.envMap?Fn("envMapIntensity","float",e.material):Fn("environmentIntensity","float",e.scene),a=n.useAnisotropy===!0||n.anisotropy>0?OE:Rt,c=Ur(t,hd(Si,a)).mul(r),l=Ur(t,qE(fp)).mul(Math.PI).mul(r),u=ko(c),d=ko(l);e.context.radiance.addAssign(u),e.context.iblIrradiance.addAssign(d);const h=e.context.lightingModel.clearcoatRadiance;if(h){const p=Ur(t,hd(ia,Xs)).mul(r),g=ko(p);h.addAssign(g)}}}const hd=(i,e)=>{let t=null;return{getUV:()=>(t===null&&(t=Tt.negate().reflect(e),t=i.mul(i).mix(t,e).normalize(),t=t.transformDirection(gr)),t),getTextureLevel:()=>i}},qE=i=>({getUV:()=>i,getTextureLevel:()=>Z(1)});te("EnvironmentNode",Ip);class Dp extends Yr{constructor(e){super(),this.node=e}setup(e){e.context.irradiance.addAssign(this.node)}}te("IrradianceNode",Dp);let bc,Rc;class at extends Ie{constructor(e){super(),this.scope=e,this.isViewportNode=!0}getNodeType(){return this.scope===at.VIEWPORT?"vec4":this.scope===at.COORDINATE?"vec3":"vec2"}getUpdateType(){let e=st.NONE;return(this.scope===at.RESOLUTION||this.scope===at.VIEWPORT)&&(e=st.RENDER),this.updateType=e,e}update({renderer:e}){this.scope===at.VIEWPORT?e.getViewport(Rc):e.getDrawingBufferSize(bc)}setup(){const e=this.scope;let t=null;if(e===at.RESOLUTION)t=ze(bc||(bc=new ve));else if(e===at.VIEWPORT)t=ze(Rc||(Rc=new nt));else{t=YE.div(Ul);let n=t.x,s=t.y;/bottom/i.test(e)&&(s=s.oneMinus()),/right/i.test(e)&&(n=n.oneMinus()),t=se(n,s)}return t}generate(e){if(this.scope===at.COORDINATE){let t=e.getFragCoord();if(e.isFlipY()){const n=e.getNodeProperties(Ul).outputNode.build(e);t=`${e.getType("vec3")}( ${t}.x, ${n}.y - ${t}.y, ${t}.z )`}return t}return super.generate(e)}}at.COORDINATE="coordinate";at.RESOLUTION="resolution";at.VIEWPORT="viewport";at.TOP_LEFT="topLeft";at.BOTTOM_LEFT="bottomLeft";at.TOP_RIGHT="topRight";at.BOTTOM_RIGHT="bottomRight";const YE=de(at,at.COORDINATE),Ul=de(at,at.RESOLUTION),er=de(at,at.VIEWPORT),Hr=de(at,at.TOP_LEFT);de(at,at.BOTTOM_LEFT);de(at,at.TOP_RIGHT);de(at,at.BOTTOM_RIGHT);te("ViewportNode",at);const Rr=new ve;class $r extends xs{constructor(e=Hr,t=null,n=null){n===null&&(n=new Ef,n.minFilter=ki),super(n,e,t),this.generateMipmaps=!1,this.isOutputTextureNode=!0,this.updateBeforeType=st.FRAME}updateBefore(e){const t=e.renderer;t.getDrawingBufferSize(Rr);const n=this.value;(n.image.width!==Rr.width||n.image.height!==Rr.height)&&(n.image.width=Rr.width,n.image.height=Rr.height,n.needsUpdate=!0);const s=n.generateMipmaps;n.generateMipmaps=this.generateMipmaps,t.copyFramebufferToTexture(n),n.generateMipmaps=s}clone(){const e=new this.constructor(this.uvNode,this.levelNode,this.value);return e.generateMipmaps=this.generateMipmaps,e}}const $E=B($r),Up=B($r,null,null,{generateMipmaps:!0});O("viewportTexture",$E);O("viewportMipTexture",Up);te("ViewportTextureNode",$r);let Cc=null;class Op extends $r{constructor(e=Hr,t=null){Cc===null&&(Cc=new qr),super(e,t,Cc)}}const Fp=B(Op);O("viewportDepthTexture",Fp);te("ViewportDepthTextureNode",Op);class Pn extends Ie{constructor(e,t=null){super("float"),this.scope=e,this.valueNode=t,this.isViewportDepthNode=!0}generate(e){const{scope:t}=this;return t===Pn.DEPTH?e.getFragDepth():super.generate(e)}setup({camera:e}){const{scope:t}=this,n=this.valueNode;let s=null;if(t===Pn.DEPTH)n!==null?s=Bp().assign(n):e.isPerspectiveCamera?s=jE(rn.z,Nr,Ar):s=Xo(rn.z,Nr,Ar);else if(t===Pn.LINEAR_DEPTH)if(n!==null)if(e.isPerspectiveCamera){const r=zp(n,Nr,Ar);s=Xo(r,Nr,Ar)}else s=n;else s=Xo(rn.z,Nr,Ar);return s}}const Xo=(i,e,t)=>i.add(e).div(e.sub(t)),jE=(i,e,t)=>e.add(i).mul(t).div(t.sub(e).mul(i)),zp=(i,e,t)=>e.mul(t).div(t.sub(e).mul(i).sub(t));Pn.DEPTH="depth";Pn.LINEAR_DEPTH="linearDepth";const Bp=B(Pn,Pn.DEPTH),Vp=de(Pn,Pn.DEPTH),KE=B(Pn,Pn.LINEAR_DEPTH);KE(Fp());Vp.assign=i=>Bp(i);te("ViewportDepthNode",Pn);class ji extends Ie{constructor(e=ji.DEFAULT){super(),this.scope=e}setup(e){super.setup(e);const t=e.clippingContext,{localClipIntersection:n,localClippingCount:s,globalClippingCount:r}=t,o=r+s,a=n?o-s:o;return this.scope===ji.ALPHA_TO_COVERAGE?this.setupAlphaToCoverage(t.planes,o,a):this.setupDefault(t.planes,o,a)}setupAlphaToCoverage(e,t,n){return he(()=>{const s=bl(e),r=Et("float","distanceToPlane"),o=Et("float","distanceToGradient"),a=Et("float","clipOpacity");a.assign(1);let c;if(Kn(n,({i:l})=>{c=s.element(l),r.assign(rn.dot(c.xyz).negate().add(c.w)),o.assign(r.fwidth().div(2)),a.mulAssign(li(o.negate(),o,r)),a.equal(0).discard()}),n<t){const l=Et("float","unionclipOpacity");l.assign(1),Kn({start:n,end:t},({i:u})=>{c=s.element(u),r.assign(rn.dot(c.xyz).negate().add(c.w)),o.assign(r.fwidth().div(2)),l.mulAssign(li(o.negate(),o,r).oneMinus())}),a.mulAssign(l.oneMinus())}_t.a.mulAssign(a),_t.a.equal(0).discard()})()}setupDefault(e,t,n){return he(()=>{const s=bl(e);let r;if(Kn(n,({i:o})=>{r=s.element(o),rn.dot(r.xyz).greaterThan(r.w).discard()}),n<t){const o=Et("bool","clipped");o.assign(!0),Kn({start:n,end:t},({i:a})=>{r=s.element(a),o.assign(rn.dot(r.xyz).greaterThan(r.w).and(o))}),o.discard()}})()}}ji.ALPHA_TO_COVERAGE="alphaToCoverage";ji.DEFAULT="default";const ZE=()=>ce(new ji),JE=()=>ce(new ji(ji.ALPHA_TO_COVERAGE));class Hp extends Ie{constructor(){super("bool"),this.isFrontFacingNode=!0}generate(e){const{renderer:t,material:n}=e;return t.coordinateSystem===jn&&n.side===pn?"false":e.getFrontFacing()}}const QE=de(Hp),ua=Z(QE).mul(2).sub(1);te("FrontFacingNode",Hp);const Ol=new Map;class ln extends an{constructor(){super(),this.isNodeMaterial=!0,this.type=this.constructor.type,this.forceSinglePass=!1,this.fog=!0,this.lights=!0,this.normals=!0,this.lightsNode=null,this.envNode=null,this.aoNode=null,this.colorNode=null,this.normalNode=null,this.opacityNode=null,this.backdropNode=null,this.backdropAlphaNode=null,this.alphaTestNode=null,this.positionNode=null,this.depthNode=null,this.shadowNode=null,this.shadowPositionNode=null,this.outputNode=null,this.fragmentNode=null,this.vertexNode=null}customProgramCacheKey(){return this.type+Cf(this)}build(e){this.setup(e)}setup(e){e.addStack(),e.stack.outputNode=this.vertexNode||this.setupPosition(e),e.addFlow("vertex",e.removeStack()),e.addStack();let t;const n=this.setupClipping(e);if(this.depthWrite===!0&&this.setupDepth(e),this.fragmentNode===null){this.normals===!0&&this.setupNormal(e),this.setupDiffuseColor(e),this.setupVariants(e);const s=this.setupLighting(e);n!==null&&e.stack.add(n);const r=Me(s,_t.a).max(0);t=this.setupOutput(e,r),US.assign(t),this.outputNode!==null&&(t=this.outputNode)}else{let s=this.fragmentNode;s.isOutputStructNode!==!0&&(s=Me(s)),t=this.setupOutput(e,s)}e.stack.outputNode=t,e.addFlow("fragment",e.removeStack())}setupClipping(e){if(e.clippingContext===null)return null;const{globalClippingCount:t,localClippingCount:n}=e.clippingContext;let s=null;return(t||n)&&(this.alphaToCoverage?s=JE():e.stack.add(ZE())),s}setupDepth(e){const{renderer:t}=e;let n=this.depthNode;n===null&&t.logarithmicDepthBuffer===!0&&(n=id().w.add(1).log2().mul(YT).mul(.5)),n!==null&&Vp.assign(n).append()}setupPosition(e){const{object:t}=e,n=t.geometry;if(e.addStack(),(n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color)&&bE(t).append(),t.isSkinnedMesh===!0&&AE(t).append(),this.displacementMap){const r=Ni("displacementMap","texture"),o=Ni("displacementScale","float"),a=Ni("displacementBias","float");Jt.addAssign(Jn.normalize().mul(r.x.mul(o).add(a)))}t.isBatchedMesh&&NE(t).append(),t.instanceMatrix&&t.instanceMatrix.isInstancedBufferAttribute===!0&&EE(t).append(),this.positionNode!==null&&Jt.assign(this.positionNode);const s=id();return e.context.vertex=e.removeStack(),e.context.mvp=s,s}setupDiffuseColor({object:e,geometry:t}){let n=this.colorNode?Me(this.colorNode):Vr;this.vertexColors===!0&&t.hasAttribute("color")&&(n=Me(n.xyz.mul(nn("color","vec3")),n.a)),e.instanceColor&&(n=ei("vec3","vInstanceColor").mul(n)),_t.assign(n);const s=this.opacityNode?Z(this.opacityNode):pp;if(_t.a.assign(_t.a.mul(s)),this.alphaTestNode!==null||this.alphaTest>0){const r=this.alphaTestNode!==null?Z(this.alphaTestNode):KT;_t.a.lessThanEqual(r).discard()}this.transparent===!1&&this.blending===hs&&this.alphaToCoverage===!1&&_t.a.assign(1)}setupVariants(){}setupNormal(){if(this.flatShading===!0){const e=rn.dFdx().cross(rn.dFdy()).normalize();Rt.assign(e.mul(ua))}else{const e=this.normalNode?q(this.normalNode):sE;Rt.assign(e.mul(ua))}}getEnvNode(e){let t=null;return this.envNode?t=this.envNode:this.envMap?t=this.envMap.isCubeTexture?bp(this.envMap):Kt(this.envMap):e.environmentNode&&(t=e.environmentNode),t}setupLights(e){const t=this.getEnvNode(e),n=[];if(t&&n.push(new Ip(t)),e.material.lightMap&&n.push(new Dp(Ni("lightMap","texture"))),this.aoNode!==null||e.material.aoMap){const r=this.aoNode!==null?this.aoNode:Kt(e.material.aoMap);n.push(new Rp(r))}let s=this.lightsNode||e.lightsNode;return n.length>0&&(s=IE([...s.lightNodes,...n])),s}setupLightingModel(){}setupLighting(e){const{material:t}=e,{backdropNode:n,backdropAlphaNode:s,emissiveNode:r}=this,a=this.lights===!0||this.lightsNode!==null?this.setupLights(e):null;let c=_t.rgb;if(a&&a.hasLight!==!1){const l=this.setupLightingModel(e);c=Lp(a,l,n,s)}else n!==null&&(c=q(s!==null?Ft(c,n,s):n));return(r&&r.isNode===!0||t.emissive&&t.emissive.isColor===!0)&&(c=c.add(q(r||JT))),c}setupOutput(e,t){if(this.fog===!0){const n=e.fogNode;n&&(t=Me(n.mix(t.rgb,n.colorNode),t.a))}return t}setDefaultValues(e){for(const n in e){const s=e[n];this[n]===void 0&&(this[n]=s,s&&s.clone&&(this[n]=s.clone()))}const t=Object.getOwnPropertyDescriptors(e.constructor.prototype);for(const n in t)Object.getOwnPropertyDescriptor(this.constructor.prototype,n)===void 0&&t[n].get!==void 0&&Object.defineProperty(this.constructor.prototype,n,t[n])}toJSON(e){const t=e===void 0||typeof e=="string";t&&(e={textures:{},images:{},nodes:{}});const n=an.prototype.toJSON.call(this,e),s=ea(this);n.inputNodes={};for(const{property:o,childNode:a}of s)n.inputNodes[o]=a.toJSON(e).uuid;function r(o){const a=[];for(const c in o){const l=o[c];delete l.metadata,a.push(l)}return a}if(t){const o=r(e.textures),a=r(e.images),c=r(e.nodes);o.length>0&&(n.textures=o),a.length>0&&(n.images=a),c.length>0&&(n.nodes=c)}return n}copy(e){return this.lightsNode=e.lightsNode,this.envNode=e.envNode,this.colorNode=e.colorNode,this.normalNode=e.normalNode,this.opacityNode=e.opacityNode,this.backdropNode=e.backdropNode,this.backdropAlphaNode=e.backdropAlphaNode,this.alphaTestNode=e.alphaTestNode,this.positionNode=e.positionNode,this.depthNode=e.depthNode,this.shadowNode=e.shadowNode,this.shadowPositionNode=e.shadowPositionNode,this.outputNode=e.outputNode,this.fragmentNode=e.fragmentNode,this.vertexNode=e.vertexNode,super.copy(e)}static fromMaterial(e){if(e.isNodeMaterial===!0)return e;const t=e.type.replace("Material","NodeMaterial"),n=eN(t);if(n===void 0)throw new Error(`NodeMaterial: Material "${e.type}" is not compatible.`);for(const s in e)n[s]=e[s];return n}}function qt(i,e){if(typeof e!="function"||!i)throw new Error(`Node material ${i} is not a class`);if(Ol.has(i)){console.warn(`Redefinition of node material ${i}`);return}Ol.set(i,e),e.type=i}function eN(i){const e=Ol.get(i);if(e!==void 0)return new e}qt("NodeMaterial",ln);class kp extends Ie{constructor(e=null){super(),this.nodes=[],this.outputNode=null,this.parent=e,this._currentCond=null,this.isStackNode=!0}getNodeType(e){return this.outputNode?this.outputNode.getNodeType(e):"void"}add(e){return this.nodes.push(e),this}if(e,t){const n=new Dr(t);return this._currentCond=Un(e,n),this.add(this._currentCond)}elseif(e,t){const n=new Dr(t),s=Un(e,n);return this._currentCond.elseNode=s,this._currentCond=s,this}else(e){return this._currentCond.elseNode=new Dr(e),this}build(e,...t){const n=aS();Zh(this);for(const s of this.nodes)s.build(e,"void");return Zh(n),this.outputNode?this.outputNode.build(e,...t):super.build(e,...t)}}B(kp);te("StackNode",kp);class Gp extends ct{constructor(e=SE){super("vec2"),this.dirNode=e}setup(){const e=this.dirNode,t=e.z.atan2(e.x).mul(1/(Math.PI*2)).add(.5),n=e.y.clamp(-1,1).asin().mul(1/Math.PI).add(.5);return se(t,n)}}B(Gp);te("EquirectUVNode",Gp);class Wp extends Ie{constructor(e){super(),this.types=e,this.isStructTypeNode=!0}getMemberTypes(){return this.types}}te("StructTypeNode",Wp);class Xp extends Ie{constructor(...e){super(),this.members=e,this.isOutputStructNode=!0}setup(e){super.setup(e);const t=this.members,n=[];for(let s=0;s<t.length;s++)n.push(t[s].getNodeType(e));this.nodeType=e.getStructTypeFromNode(new Wp(n)).name}generate(e,t){const n=e.getOutputStructName(),s=this.members,r=n!==""?n+".":"";for(let o=0;o<s.length;o++){const a=s[o].build(e,t);e.addLineFlowCode(`${r}m${o} = ${a}`)}return n}}B(Xp);te("OutputStructNode",Xp);class qp extends Ie{constructor(e){super(),this.seedNode=e}setup(){const e=this.seedNode.toUint().mul(747796405).add(2891336453),t=e.shiftRight(e.shiftRight(28).add(4)).bitXor(e).mul(277803737);return t.shiftRight(22).bitXor(t).toFloat().mul(1/2**32)}}const tN=B(qp);O("hash",tN);te("HashNode",qp);const Fl=(i,e)=>Ei(ft(4,i.mul(ci(1,i))),e),nN=(i,e)=>i.lessThan(.5)?Fl(i.mul(2),e).div(2):ci(1,Fl(ft(ci(1,i),2),e).div(2)),iN=(i,e,t)=>Ei(Ci(Ei(i,e),yn(Ei(i,e),Ei(ci(1,i),t))),1/e),sN=(i,e)=>Rn(Jh.mul(e.mul(i).sub(1))).div(Jh.mul(e.mul(i).sub(1)));O("parabola",Fl);O("gain",nN);O("pcurve",iN);O("sinc",sN);const ri=he(([i])=>i.fract().sub(.5).abs()),Yp=he(([i])=>q(ri(i.z.add(ri(i.y.mul(1)))),ri(i.z.add(ri(i.x.mul(1)))),ri(i.y.add(ri(i.x.mul(1)))))),rN=he(([i,e,t])=>{const n=q(i).toVar(),s=Z(1.4).toVar(),r=Z(0).toVar(),o=q(n).toVar();return Kn({start:Z(0),end:Z(3),type:"float",condition:"<="},()=>{const a=q(Yp(o.mul(2))).toVar();n.addAssign(a.add(t.mul(Z(.1).mul(e)))),o.mulAssign(1.8),s.mulAssign(1.5),n.mulAssign(1.2);const c=Z(ri(n.z.add(ri(n.x.add(ri(n.y)))))).toVar();r.addAssign(c.div(s)),o.addAssign(.14)}),r});ri.setLayout({name:"tri",type:"float",inputs:[{name:"x",type:"float"}]});Yp.setLayout({name:"tri3",type:"vec3",inputs:[{name:"p",type:"vec3"}]});rN.setLayout({name:"triNoise3D",type:"float",inputs:[{name:"p",type:"vec3"},{name:"spd",type:"float"},{name:"time",type:"float"}]});let Lc;class $p extends bu{constructor(e){Lc=Lc||Ia("discard"),super(e,Lc)}}const oN=B($p),aN=i=>oN(i).append();O("discard",aN);te("DiscardNode",$p);class jp extends Ie{constructor(e=[],...t){super(),this.functionNodes=e,this.parametersNodes=t,this._candidateFnCall=null,this.global=!0}getNodeType(){return this.functionNodes[0].shaderNode.layout.type}setup(e){const t=this.parametersNodes;let n=this._candidateFnCall;if(n===null){let s=null,r=-1;for(const o of this.functionNodes){const c=o.shaderNode.layout;if(c===null)throw new Error("FunctionOverloadingNode: FunctionNode must be a layout.");const l=c.inputs;if(t.length===l.length){let u=0;for(let d=0;d<t.length;d++){const h=t[d],p=l[d];h.getNodeType(e)===p.type?u++:u=0}u>r&&(s=o,r=u)}}this._candidateFnCall=n=s(...t)}return n}}B(jp);te("FunctionOverloadingNode",jp);class Kp extends ct{constructor(){super("vec2")}setup(){const e=q(Tt.z,0,Tt.x.negate()).normalize(),t=Tt.cross(e);return se(e.dot(Rt),t.dot(Rt)).mul(.495).add(.5)}}const cN=de(Kp);te("MatcapUVNode",Kp);class _n extends _s{constructor(e=_n.LOCAL,t=1,n=0){super(n),this.scope=e,this.scale=t,this.updateType=st.FRAME}update(e){const t=this.scope,n=this.scale;t===_n.LOCAL?this.value+=e.deltaTime*n:t===_n.DELTA?this.value=e.deltaTime*n:t===_n.FRAME?this.value=e.frameId:this.value=e.time*n}serialize(e){super.serialize(e),e.scope=this.scope,e.scale=this.scale}deserialize(e){super.deserialize(e),this.scope=e.scope,this.scale=e.scale}}_n.LOCAL="local";_n.GLOBAL="global";_n.DELTA="delta";_n.FRAME="frame";const lN=(i,e=0)=>ce(new _n(_n.LOCAL,i,e));de(_n,_n.FRAME).toUint();te("TimerNode",_n);class Ht extends Ie{constructor(e=Ht.SINE,t=lN()){super(),this.method=e,this.timeNode=t}getNodeType(e){return this.timeNode.getNodeType(e)}setup(){const e=this.method,t=ce(this.timeNode);let n=null;return e===Ht.SINE?n=t.add(.75).mul(Math.PI*2).sin().mul(.5).add(.5):e===Ht.SQUARE?n=t.fract().round():e===Ht.TRIANGLE?n=t.add(.5).fract().mul(2).sub(1).abs():e===Ht.SAWTOOTH&&(n=t.fract()),n}serialize(e){super.serialize(e),e.method=this.method}deserialize(e){super.deserialize(e),this.method=e.method}}Ht.SINE="sine";Ht.SQUARE="square";Ht.TRIANGLE="triangle";Ht.SAWTOOTH="sawtooth";B(Ht,Ht.SINE);B(Ht,Ht.SQUARE);B(Ht,Ht.TRIANGLE);B(Ht,Ht.SAWTOOTH);te("OscNode",Ht);class ui extends ct{constructor(e,t){super(),this.scope=e,this.node=t}getNodeType(e){return this.node.getNodeType(e)}setup(){const{scope:e,node:t}=this;let n=null;return e===ui.DIRECTION_TO_COLOR?n=t.mul(.5).add(.5):e===ui.COLOR_TO_DIRECTION&&(n=t.mul(2).sub(1)),n}}ui.DIRECTION_TO_COLOR="directionToColor";ui.COLOR_TO_DIRECTION="colorToDirection";const Zp=B(ui,ui.DIRECTION_TO_COLOR),uN=B(ui,ui.COLOR_TO_DIRECTION);O("directionToColor",Zp);O("colorToDirection",uN);te("PackingNode",ui);class Ru extends Ie{constructor(e,t,n,s=Z(0),r=Z(1)){super(),this.node=e,this.inLowNode=t,this.inHighNode=n,this.outLowNode=s,this.outHighNode=r,this.doClamp=!0}setup(){const{node:e,inLowNode:t,inHighNode:n,outLowNode:s,outHighNode:r,doClamp:o}=this;let a=e.sub(t).div(n.sub(t));return o===!0&&(a=a.clamp()),a.mul(r.sub(s)).add(s)}}const hN=B(Ru,null,null,{doClamp:!1}),dN=B(Ru);O("remap",hN);O("remapClamp",dN);te("RemapNode",Ru);class Jp extends ct{constructor(e,t,n=se(.5)){super("vec2"),this.uvNode=e,this.rotationNode=t,this.centerNode=n}setup(){const{uvNode:e,rotationNode:t,centerNode:n}=this;return e.sub(n).rotate(t).add(n)}}const fN=B(Jp);O("rotateUV",fN);te("RotateUVNode",Jp);class Qp extends ct{constructor(e,t){super(),this.positionNode=e,this.rotationNode=t}getNodeType(e){return this.positionNode.getNodeType(e)}setup(e){const{rotationNode:t,positionNode:n}=this;if(this.getNodeType(e)==="vec2"){const r=t.cos(),o=t.sin();return mu(r,o,o.negate(),r).mul(n)}else{const r=t,o=Ks(Me(1,0,0,0),Me(0,ni(r.x),Rn(r.x).negate(),0),Me(0,Rn(r.x),ni(r.x),0),Me(0,0,0,1)),a=Ks(Me(ni(r.y),0,Rn(r.y),0),Me(0,1,0,0),Me(Rn(r.y).negate(),0,ni(r.y),0),Me(0,0,0,1)),c=Ks(Me(ni(r.z),Rn(r.z).negate(),0,0),Me(Rn(r.z),ni(r.z),0,0),Me(0,0,1,0),Me(0,0,0,1));return o.mul(a).mul(c).mul(Me(n,1)).xyz}}}const pN=B(Qp);O("rotate",pN);te("RotateNode",Qp);class em extends Ie{constructor(e,t=Sn(),n=Z(0)){super("vec2"),this.countNode=e,this.uvNode=t,this.frameNode=n}setup(){const{frameNode:e,uvNode:t,countNode:n}=this,{width:s,height:r}=n,o=e.mod(s.mul(r)).floor(),a=o.mod(s),c=r.sub(o.add(1).div(s).ceil()),l=n.reciprocal(),u=se(a,c);return t.add(u).mul(l)}}B(em);te("SpriteSheetUVNode",em);class tm extends pr{constructor(e,t){super(e,t),this.isStorageArrayElementNode=!0}set storageBufferNode(e){this.node=e}get storageBufferNode(){return this.node}setup(e){return e.isAvailable("storageBuffer")===!1&&!this.node.instanceIndex&&this.node.bufferObject===!0&&e.setupPBO(this.node),super.setup(e)}generate(e,t){let n;const s=e.context.assign;if(e.isAvailable("storageBuffer")===!1){const{node:r}=this;!r.instanceIndex&&this.node.bufferObject===!0&&s!==!0?n=e.generatePBO(this):n=r.build(e)}else n=super.generate(e);if(s!==!0){const r=this.getNodeType(e);n=e.format(n,r,t)}return n}}const nm=B(tm);O("storageElement",nm);te("StorageArrayElementNode",tm);class im extends Ie{constructor(e,t=null,n=null,s=Z(1),r=Jt,o=Jn){super("vec4"),this.textureXNode=e,this.textureYNode=t,this.textureZNode=n,this.scaleNode=s,this.positionNode=r,this.normalNode=o}setup(){const{textureXNode:e,textureYNode:t,textureZNode:n,scaleNode:s,positionNode:r,normalNode:o}=this;let a=o.abs().normalize();a=a.div(a.dot(q(1)));const c=r.yz.mul(s),l=r.zx.mul(s),u=r.xy.mul(s),d=e.value,h=t!==null?t.value:d,p=n!==null?n.value:d,g=Kt(d,c).mul(a.x),_=Kt(h,l).mul(a.y),m=Kt(p,u).mul(a.z);return yn(g,_,m)}}const mN=B(im),gN=(...i)=>mN(...i);O("triplanarTexture",gN);te("TriplanarTexturesNode",im);new yi;new L;new L;new L;new xt;new L(0,0,-1);new nt;new L;new L;new nt;new ve;new Ri;se(Hr.x.oneMinus(),Hr.y);class _N extends gu{constructor(e=0){super(null,"vec4"),this.isVertexColorNode=!0,this.index=e}getAttributeName(){const e=this.index;return"color"+(e>0?e:"")}generate(e){const t=this.getAttributeName(e),n=e.hasGeometryAttribute(t);let s;return n===!0?s=super.generate(e):s=e.generateConst(this.nodeType,new nt(1,1,1,1)),s}serialize(e){super.serialize(e),e.index=this.index}deserialize(e){super.deserialize(e),this.index=e.index}}te("VertexColorNode",_N);class sm extends mr{constructor(e,t,n=null){super(e,t,n),this.renderer=n}updateReference(e){return this.reference=this.renderer!==null?this.renderer:e.renderer,this.reference}}const xN=(i,e,t)=>ce(new sm(i,e,t));te("RendererReferenceNode",sm);const Oa=1/6,rm=i=>ft(Oa,ft(i,ft(i,i.negate().add(3)).sub(3)).add(1)),zl=i=>ft(Oa,ft(i,ft(i,ft(3,i).sub(6))).add(4)),om=i=>ft(Oa,ft(i,ft(i,ft(-3,i).add(3)).add(3)).add(1)),Bl=i=>ft(Oa,Ei(i,3)),dd=i=>rm(i).add(zl(i)),fd=i=>om(i).add(Bl(i)),pd=i=>yn(-1,zl(i).div(rm(i).add(zl(i)))),md=i=>yn(1,Bl(i).div(om(i).add(Bl(i)))),gd=(i,e,t)=>{const n=i.uvNode,s=ft(n,e.zw).add(.5),r=Ca(s),o=La(s),a=dd(o.x),c=fd(o.x),l=pd(o.x),u=md(o.x),d=pd(o.y),h=md(o.y),p=se(r.x.add(l),r.y.add(d)).sub(.5).mul(e.xy),g=se(r.x.add(u),r.y.add(d)).sub(.5).mul(e.xy),_=se(r.x.add(l),r.y.add(h)).sub(.5).mul(e.xy),m=se(r.x.add(u),r.y.add(h)).sub(.5).mul(e.xy),f=dd(o.y).mul(yn(a.mul(i.uv(p).level(t)),c.mul(i.uv(g).level(t)))),E=fd(o.y).mul(yn(a.mul(i.uv(_).level(t)),c.mul(i.uv(m).level(t))));return f.add(E)},vN=(i,e)=>{const t=se(i.size(Vt(e))),n=se(i.size(Vt(e.add(1)))),s=Ci(1,t),r=Ci(1,n),o=gd(i,Me(s,t),Ca(e)),a=gd(i,Me(r,n),tp(e));return La(e).mix(o,a)};class am extends ct{constructor(e,t=Z(3)){super("vec4"),this.textureNode=e,this.blurNode=t}setup(){return vN(this.textureNode,this.blurNode)}}const yN=B(am);O("bicubic",yN);te("TextureBicubicNode",am);class cm extends Ie{constructor(){super("vec2"),this.isPointUVNode=!0}generate(){return"vec2( gl_PointCoord.x, 1.0 - gl_PointCoord.y )"}}de(cm);te("PointUVNode",cm);class Zn extends Ie{constructor(e=Zn.BACKGROUND_BLURRINESS,t=null){super(),this.scope=e,this.scene=t}setup(e){const t=this.scope,n=this.scene!==null?this.scene:e.scene;let s;return t===Zn.BACKGROUND_BLURRINESS?s=Fn("backgroundBlurriness","float",n):t===Zn.BACKGROUND_INTENSITY?s=Fn("backgroundIntensity","float",n):console.error("THREE.SceneNode: Unknown scope:",t),s}}Zn.BACKGROUND_BLURRINESS="backgroundBlurriness";Zn.BACKGROUND_INTENSITY="backgroundIntensity";de(Zn,Zn.BACKGROUND_BLURRINESS);de(Zn,Zn.BACKGROUND_INTENSITY);te("SceneNode",Zn);const _d={Uniform:"uniform",Storage:"storage",ReadOnlyStorage:"read-only-storage"},Pc={WriteOnly:"write-only",ReadOnly:"read-only",ReadWrite:"read-write"};class MN extends Da{constructor(e,t,n=0){super(e,t,n),this.isStorageBufferNode=!0,this.access=_d.Storage,this.bufferObject=!1,this.bufferCount=n,this._attribute=null,this._varying=null,this.global=!0,e.isStorageBufferAttribute!==!0&&e.isStorageInstancedBufferAttribute!==!0&&(e.isInstancedBufferAttribute?e.isStorageInstancedBufferAttribute=!0:e.isStorageBufferAttribute=!0)}getHash(e){if(this.bufferCount===0){let t=e.globalCache.getData(this.value);return t===void 0&&(t={node:this},e.globalCache.setData(this.value,t)),t.node.uuid}return this.uuid}getInputType(){return"storageBuffer"}element(e){return nm(this,e)}setBufferObject(e){return this.bufferObject=e,this}setAccess(e){return this.access=e,this}toReadOnly(){return this.setAccess(_d.ReadOnlyStorage)}generate(e){if(e.isAvailable("storageBuffer"))return super.generate(e);const t=this.getNodeType(e);this._attribute===null&&(this._attribute=Ua(this.value),this._varying=Ot(this._attribute));const n=this._varying.build(e,t);return e.registerTransform(n,this._attribute),n}}te("StorageBufferNode",MN);class lm extends xs{constructor(e,t,n=null){super(e,t),this.storeNode=n,this.isStorageTextureNode=!0,this.access=Pc.WriteOnly}getInputType(){return"storageTexture"}setup(e){super.setup(e);const t=e.getNodeProperties(this);t.storeNode=this.storeNode}setAccess(e){return this.access=e,this}generate(e,t){let n;return this.storeNode!==null?n=this.generateStore(e):n=super.generate(e,t),n}toReadOnly(){return this.setAccess(Pc.ReadOnly)}toWriteOnly(){return this.setAccess(Pc.WriteOnly)}generateStore(e){const t=e.getNodeProperties(this),{uvNode:n,storeNode:s}=t,r=super.generate(e,"property"),o=n.build(e,"uvec2"),a=s.build(e,"vec4"),c=e.generateTextureStore(e,r,o,a);e.addLineFlowCode(c)}}B(lm);te("StorageTextureNode",lm);const SN=he(({texture:i,uv:e})=>{const n=q().temp();return Lt(e.x.lessThan(1e-4),()=>{n.assign(q(1,0,0))}).elseif(e.y.lessThan(1e-4),()=>{n.assign(q(0,1,0))}).elseif(e.z.lessThan(1e-4),()=>{n.assign(q(0,0,1))}).elseif(e.x.greaterThan(1-1e-4),()=>{n.assign(q(-1,0,0))}).elseif(e.y.greaterThan(1-1e-4),()=>{n.assign(q(0,-1,0))}).elseif(e.z.greaterThan(1-1e-4),()=>{n.assign(q(0,0,-1))}).else(()=>{const r=i.uv(e.add(q(-.01,0,0))).r.sub(i.uv(e.add(q(.01,0,0))).r),o=i.uv(e.add(q(0,-.01,0))).r.sub(i.uv(e.add(q(0,.01,0))).r),a=i.uv(e.add(q(0,0,-.01))).r.sub(i.uv(e.add(q(0,0,.01))).r);n.assign(q(r,o,a))}),n.normalize()});class um extends xs{constructor(e,t=null,n=null){super(e,t,n),this.isTexture3DNode=!0}getInputType(){return"texture3D"}getDefaultUV(){return q(.5,.5,.5)}setUpdateMatrix(){}setupUV(e,t){return t}generateUV(e,t){return t.build(e,"vec3")}normal(e){return SN({texture:this,uv:e})}}const TN=B(um);te("Texture3DNode",um);class EN extends mr{constructor(e,t,n=null){super(e,t,n),this.userData=n}update(e){this.reference=this.userData!==null?this.userData:e.object.userData,super.update(e)}}te("UserDataNode",EN);const NN=he(({base:i,blend:e})=>{const t=n=>e[n].lessThan(Zf).cond(e[n],i[n].oneMinus().div(e[n]).oneMinus().max(0));return q(t("x"),t("y"),t("z"))}).setLayout({name:"burnColor",type:"vec3",inputs:[{name:"base",type:"vec3"},{name:"blend",type:"vec3"}]}),AN=he(({base:i,blend:e})=>{const t=n=>e[n].equal(1).cond(e[n],i[n].div(e[n].oneMinus()).max(0));return q(t("x"),t("y"),t("z"))}).setLayout({name:"dodgeColor",type:"vec3",inputs:[{name:"base",type:"vec3"},{name:"blend",type:"vec3"}]}),wN=he(({base:i,blend:e})=>{const t=n=>i[n].oneMinus().mul(e[n].oneMinus()).oneMinus();return q(t("x"),t("y"),t("z"))}).setLayout({name:"screenColor",type:"vec3",inputs:[{name:"base",type:"vec3"},{name:"blend",type:"vec3"}]}),bN=he(({base:i,blend:e})=>{const t=n=>i[n].lessThan(.5).cond(i[n].mul(e[n],2),i[n].oneMinus().mul(e[n].oneMinus()).oneMinus());return q(t("x"),t("y"),t("z"))}).setLayout({name:"overlayColor",type:"vec3",inputs:[{name:"base",type:"vec3"},{name:"blend",type:"vec3"}]});class Xt extends ct{constructor(e,t,n){super(),this.blendMode=e,this.baseNode=t,this.blendNode=n}setup(){const{blendMode:e,baseNode:t,blendNode:n}=this,s={base:t,blend:n};let r=null;return e===Xt.BURN?r=NN(s):e===Xt.DODGE?r=AN(s):e===Xt.SCREEN?r=wN(s):e===Xt.OVERLAY&&(r=bN(s)),r}}Xt.BURN="burn";Xt.DODGE="dodge";Xt.SCREEN="screen";Xt.OVERLAY="overlay";const RN=B(Xt,Xt.BURN),CN=B(Xt,Xt.DODGE),LN=B(Xt,Xt.OVERLAY),PN=B(Xt,Xt.SCREEN);O("burn",RN);O("dodge",CN);O("overlay",LN);O("screen",PN);te("BlendModeNode",Xt);const IN=he(({textureNode:i,bumpScale:e})=>{const t=s=>i.cache().context({getUV:r=>s(r.uvNode||Sn()),forceUVContext:!0}),n=Z(t(s=>s));return se(Z(t(s=>s.add(s.dFdx()))).sub(n),Z(t(s=>s.add(s.dFdy()))).sub(n)).mul(e)}),DN=he(i=>{const{surf_pos:e,surf_norm:t,dHdxy:n}=i,s=e.dFdx().normalize(),r=e.dFdy().normalize(),o=t,a=r.cross(o),c=o.cross(s),l=s.dot(a).mul(ua),u=l.sign().mul(n.x.mul(a).add(n.y.mul(c)));return l.abs().mul(t).sub(u).normalize()});class hm extends ct{constructor(e,t=null){super("vec3"),this.textureNode=e,this.scaleNode=t}setup(){const e=this.scaleNode!==null?this.scaleNode:1,t=IN({textureNode:this.textureNode,bumpScale:e});return DN({surf_pos:rn,surf_norm:$i,dHdxy:t})}}const UN=B(hm);O("bumpMap",UN);te("BumpMapNode",hm);const ON=he(({color:i,adjustment:e})=>e.mix(Wn(i.rgb),i.rgb)),FN=he(({color:i,adjustment:e})=>{const t=yn(i.r,i.g,i.b).div(3),n=i.r.max(i.g.max(i.b)),s=n.sub(t).mul(e).mul(-3);return Ft(i.rgb,n,s)}),zN=he(({color:i,adjustment:e})=>{const t=q(.57735,.57735,.57735),n=e.cos();return q(i.rgb.mul(n).add(t.cross(i.rgb).mul(e.sin()).add(t.mul(Pa(t,i.rgb).mul(n.oneMinus())))))});class vn extends ct{constructor(e,t,n=Z(1)){super("vec3"),this.method=e,this.colorNode=t,this.adjustmentNode=n}setup(){const{method:e,colorNode:t,adjustmentNode:n}=this,s={color:t,adjustment:n};let r=null;return e===vn.SATURATION?r=ON(s):e===vn.VIBRANCE?r=FN(s):e===vn.HUE?r=zN(s):console.error(`${this.type}: Method "${this.method}" not supported!`),r}}vn.SATURATION="saturation";vn.VIBRANCE="vibrance";vn.HUE="hue";const BN=B(vn,vn.SATURATION),VN=B(vn,vn.VIBRANCE),HN=B(vn,vn.HUE),kN=q(.2125,.7154,.0721),Wn=(i,e=kN)=>Pa(i,e),dm=(i,e)=>Ft(q(0),i,Wn(i).sub(e).max(0));O("saturation",BN);O("vibrance",VN);O("hue",HN);O("threshold",dm);te("ColorAdjustmentNode",vn);const GN=he(i=>{const{eye_pos:e,surf_norm:t,mapN:n,uv:s}=i,r=e.dFdx(),o=e.dFdy(),a=s.dFdx(),c=s.dFdy(),l=t,u=o.cross(l),d=l.cross(r),h=u.mul(a.x).add(d.mul(c.x)),p=u.mul(a.y).add(d.mul(c.y)),g=h.dot(h).max(p.dot(p)),_=ua.mul(g.inverseSqrt());return yn(h.mul(n.x,_),p.mul(n.y,_),l.mul(n.z)).normalize()});class fm extends ct{constructor(e,t=null){super("vec3"),this.node=e,this.scaleNode=t,this.normalMapType=bi}setup(e){const{normalMapType:t,scaleNode:n}=this;let s=this.node.mul(2).sub(1);n!==null&&(s=q(s.xy.mul(n),s.z));let r=null;return t===sf?r=dp.mul(s).normalize():t===bi&&(e.hasGeometryAttribute("tangent")===!0?r=qs.mul(s).normalize():r=GN({eye_pos:rn,surf_norm:$i,mapN:s,uv:Sn()})),r}}const WN=B(fm);O("normalMap",WN);te("NormalMapNode",fm);class pm extends ct{constructor(e,t){super(),this.sourceNode=e,this.stepsNode=t}setup(){const{sourceNode:e,stepsNode:t}=this;return e.mul(t).floor().div(t)}}const XN=B(pm);O("posterize",XN);te("PosterizeNode",pm);const qN=he(({color:i,exposure:e})=>i.mul(e).clamp()),YN=he(({color:i,exposure:e})=>(i=i.mul(e),i.div(i.add(1)).clamp())),$N=he(({color:i,exposure:e})=>{i=i.mul(e),i=i.sub(.004).max(0);const t=i.mul(i.mul(6.2).add(.5)),n=i.mul(i.mul(6.2).add(1.7)).add(.06);return t.div(n).pow(2.2)}),jN=he(({color:i})=>{const e=i.mul(i.add(.0245786)).sub(90537e-9),t=i.mul(i.add(.432951).mul(.983729)).add(.238081);return e.div(t)}),KN=he(({color:i,exposure:e})=>{const t=cn(.59719,.35458,.04823,.076,.90834,.01566,.0284,.13383,.83777),n=cn(1.60475,-.53108,-.07367,-.10208,1.10813,-.00605,-.00327,-.07276,1.07602);return i=i.mul(e).div(.6),i=t.mul(i),i=jN({color:i}),i=n.mul(i),i.clamp()}),ZN=cn(q(1.6605,-.1246,-.0182),q(-.5876,1.1329,-.1006),q(-.0728,-.0083,1.1187)),JN=cn(q(.6274,.0691,.0164),q(.3293,.9195,.088),q(.0433,.0113,.8956)),QN=he(([i])=>{const e=q(i).toVar(),t=q(e.mul(e)).toVar(),n=q(t.mul(t)).toVar();return Z(15.5).mul(n.mul(t)).sub(ft(40.14,n.mul(e))).add(ft(31.96,n).sub(ft(6.868,t.mul(e))).add(ft(.4298,t).add(ft(.1191,e).sub(.00232))))}),eA=he(({color:i,exposure:e})=>{const t=q(i).toVar(),n=cn(q(.856627153315983,.137318972929847,.11189821299995),q(.0951212405381588,.761241990602591,.0767994186031903),q(.0482516061458583,.101439036467562,.811302368396859)),s=cn(q(1.1271005818144368,-.1413297634984383,-.14132976349843826),q(-.11060664309660323,1.157823702216272,-.11060664309660294),q(-.016493938717834573,-.016493938717834257,1.2519364065950405)),r=Z(-12.47393),o=Z(4.026069);return t.mulAssign(e),t.assign(JN.mul(t)),t.assign(n.mul(t)),t.assign(fn(t,1e-10)),t.assign(Ra(t)),t.assign(t.sub(r).div(o.sub(r))),t.assign(ps(t,0,1)),t.assign(QN(t)),t.assign(s.mul(t)),t.assign(Ei(fn(q(0),t),q(2.2))),t.assign(ZN.mul(t)),t.assign(ps(t,0,1)),t}),tA=he(({color:i,exposure:e})=>{const t=Z(.76),n=Z(.15);i=i.mul(e);const s=Ti(i.r,Ti(i.g,i.b)),r=Un(s.lessThan(.08),s.sub(ft(6.25,s.mul(s))),.04);i.subAssign(r);const o=fn(i.r,fn(i.g,i.b));Lt(o.lessThan(t),()=>i);const a=ci(1,t),c=ci(1,a.mul(a).div(o.add(a.sub(t))));i.mulAssign(c.div(o));const l=ci(1,Ci(1,n.mul(o.sub(c)).add(1)));return Ft(i,q(c),l)}).setLayout({name:"NeutralToneMapping",type:"vec3",inputs:[{name:"color",type:"vec3"},{name:"exposure",type:"float"}]}),nA={[Vd]:qN,[Hd]:YN,[kd]:$N,[Gd]:KN,[Wd]:eA,[Xd]:tA};class mm extends ct{constructor(e=Ln,t=sA,n=null){super("vec3"),this.toneMapping=e,this.exposureNode=t,this.colorNode=n}getCacheKey(){let e=super.getCacheKey();return e="{toneMapping:"+this.toneMapping+",nodes:"+e+"}",e}setup(e){const t=this.colorNode||e.context.color,n=this.toneMapping;if(n===Ln)return t;const s={exposure:this.exposureNode,color:t},r=nA[n];let o=null;return r?o=r(s):(console.error("ToneMappingNode: Unsupported Tone Mapping configuration.",n),o=t),o}}const iA=(i,e,t)=>ce(new mm(i,ce(e),ce(t))),sA=xN("toneMappingExposure","float");O("toneMapping",(i,e,t)=>iA(e,t,i));te("ToneMappingNode",mm);let Ic=null;class gm extends $r{constructor(e=Hr,t=null){Ic===null&&(Ic=new Ef),super(e,t,Ic)}updateReference(){return this}}const rA=B(gm);O("viewportSharedTexture",rA);te("ViewportSharedTextureNode",gm);const oA=new ve;class Vl extends xs{constructor(e,t){super(t),this.passNode=e,this.setUpdateMatrix(!1)}setup(e){return this.passNode.build(e),super.setup(e)}clone(){return new this.constructor(this.passNode,this.value)}}class jr extends ct{constructor(e,t,n){super("vec4"),this.scope=e,this.scene=t,this.camera=n,this._pixelRatio=1,this._width=1,this._height=1;const s=new qr;s.isRenderTargetTexture=!0,s.name="PostProcessingDepth";const r=new Ri(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:hr});r.texture.name="PostProcessing",r.depthTexture=s,this.renderTarget=r,this.updateBeforeType=st.FRAME,this._textureNode=ce(new Vl(this,r.texture)),this._depthTextureNode=ce(new Vl(this,s)),this._linearDepthNode=null,this._viewZNode=null,this._cameraNear=ze(0),this._cameraFar=ze(0),this.isPassNode=!0}isGlobal(){return!0}getTextureNode(){return this._textureNode}getTextureDepthNode(){return this._depthTextureNode}getViewZNode(){if(this._viewZNode===null){const e=this._cameraNear,t=this._cameraFar;this._viewZNode=zp(this._depthTextureNode,e,t)}return this._viewZNode}getLinearDepthNode(){if(this._linearDepthNode===null){const e=this._cameraNear,t=this._cameraFar;this._linearDepthNode=Xo(this.getViewZNode(),e,t)}return this._linearDepthNode}setup(){return this.scope===jr.COLOR?this.getTextureNode():this.getLinearDepthNode()}updateBefore(e){const{renderer:t}=e,{scene:n,camera:s}=this;this._pixelRatio=t.getPixelRatio();const r=t.getSize(oA);this.setSize(r.width,r.height);const o=t.toneMapping,a=t.toneMappingNode,c=t.getRenderTarget();this._cameraNear.value=s.near,this._cameraFar.value=s.far,t.toneMapping=Ln,t.toneMappingNode=null,t.setRenderTarget(this.renderTarget),t.render(n,s),t.toneMapping=o,t.toneMappingNode=a,t.setRenderTarget(c)}setSize(e,t){this._width=e,this._height=t;const n=this._width*this._pixelRatio,s=this._height*this._pixelRatio;this.renderTarget.setSize(n,s)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget.dispose()}}jr.COLOR="color";jr.DEPTH="depth";const Fa=(i,e)=>ce(new Vl(i,e));te("PassNode",jr);const Dc=new su(-1,1,1,-1,0,1);class aA extends Bn{constructor(e=!1){super();const t=e===!1?[0,-1,0,1,2,1]:[0,2,0,0,2,0];this.setAttribute("position",new Zt([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new Zt(t,2))}}const cA=new aA;class Kr extends Cn{constructor(e=null){super(cA,e),this.camera=Dc}renderAsync(e){return e.renderAsync(this,Dc)}render(e){e.render(this,Dc)}}const xd=new Kr,vd=new Kr;class lA extends ct{constructor(e,t=2){super("vec4"),this.textureNode=e,this.sigma=t,this.directionNode=se(1),this._invSize=ze(new ve),this._passDirection=ze(new ve),this._horizontalRT=new Ri,this._horizontalRT.texture.name="GaussianBlurNode.horizontal",this._verticalRT=new Ri,this._verticalRT.texture.name="GaussianBlurNode.vertical",this._textureNode=Fa(this,this._verticalRT.texture),this.updateBeforeType=st.RENDER,this.resolution=new ve(1,1)}setSize(e,t){e=Math.max(Math.round(e*this.resolution.x),1),t=Math.max(Math.round(t*this.resolution.y),1),this._invSize.value.set(1/e,1/t),this._horizontalRT.setSize(e,t),this._verticalRT.setSize(e,t)}updateBefore(e){const{renderer:t}=e,n=this.textureNode,s=n.value,r=t.getRenderTarget(),o=n.value;xd.material=this._material,vd.material=this._material,this.setSize(s.image.width,s.image.height);const a=s.type;this._horizontalRT.texture.type=a,this._verticalRT.texture.type=a,t.setRenderTarget(this._horizontalRT),this._passDirection.value.set(1,0),xd.render(t),n.value=this._horizontalRT.texture,t.setRenderTarget(this._verticalRT),this._passDirection.value.set(0,1),vd.render(t),t.setRenderTarget(r),n.value=o}getTextureNode(){return this._textureNode}setup(e){const t=this.textureNode;if(t.isTextureNode!==!0)return console.error("GaussianBlurNode requires a TextureNode."),Me();const n=t.uvNode||Sn(),s=c=>t.cache().context({getUV:()=>c,forceUVContext:!0}),r=he(()=>{const c=3+2*this.sigma,l=this._getCoefficients(c),u=this._invSize,d=se(this.directionNode).mul(this._passDirection),h=Z(l[0]).toVar(),p=Me(s(n).mul(h)).toVar();for(let g=1;g<c;g++){const _=Z(g),m=Z(l[g]),f=se(d.mul(u.mul(_))).toVar(),E=Me(s(n.add(f))),v=Me(s(n.sub(f)));p.addAssign(E.add(v).mul(m)),h.addAssign(ft(2,m))}return p.div(h)}),o=this._material||(this._material=e.createNodeMaterial());o.fragmentNode=r();const a=e.getNodeProperties(this);return a.textureNode=t,this._textureNode}_getCoefficients(e){const t=[];for(let n=0;n<e;n++)t.push(.39894*Math.exp(-.5*n*n/(e*e))/e);return t}}const uA=(i,e)=>ce(new lA(ce(i),e));O("gaussianBlur",uA);const Uc=new ve,yd=new Kr;class hA extends ct{constructor(e,t=.96){super(e),this.textureNode=e,this.textureNodeOld=Kt(),this.damp=ze(t),this._compRT=new Ri,this._compRT.texture.name="AfterImageNode.comp",this._oldRT=new Ri,this._oldRT.texture.name="AfterImageNode.old",this._textureNode=Fa(this,this._compRT.texture),this.updateBeforeType=st.RENDER}getTextureNode(){return this._textureNode}setSize(e,t){this._compRT.setSize(e,t),this._oldRT.setSize(e,t)}updateBefore(e){const{renderer:t}=e,n=this.textureNode,r=n.value.type;this._compRT.texture.type=r,this._oldRT.texture.type=r,t.getDrawingBufferSize(Uc),this.setSize(Uc.x,Uc.y);const o=t.toneMapping,a=t.toneMappingNode,c=t.getRenderTarget(),l=n.value;this.textureNodeOld.value=this._oldRT.texture,t.toneMapping=Ln,t.toneMappingNode=null,t.setRenderTarget(this._compRT),yd.render(t);const u=this._oldRT;this._oldRT=this._compRT,this._compRT=u,t.toneMapping=o,t.toneMappingNode=a,t.setRenderTarget(c),n.value=l}setup(e){const t=this.textureNode,n=this.textureNodeOld;if(t.isTextureNode!==!0)return console.error("AfterImageNode requires a TextureNode."),Me();const s=t.uvNode||Sn();n.uvNode=s;const r=u=>t.cache().context({getUV:()=>u,forceUVContext:!0}),o=he(([u,d])=>{const h=Z(d).toVar(),p=Me(u).toVar();return fn(Eu(p.sub(h)),0)}),a=he(()=>{const u=Me(n),d=Me(r(s));return u.mulAssign(this.damp.mul(o(u,.1))),fn(d,u)}),c=this._materialComposed||(this._materialComposed=e.createNodeMaterial());c.fragmentNode=a(),yd.material=c;const l=e.getNodeProperties(this);return l.textureNode=t,this._textureNode}}const dA=(i,e)=>ce(new hA(ce(i),e));O("afterImage",dA);const Md=new Kr;class fA extends ct{constructor(e,t,n,s){super("vec4"),this.textureNode=e,this.tresholdNode=t,this.scaleNode=n,this.colorNode=q(.1,0,1),this.samples=s,this.resolution=new ve(1,1),this._renderTarget=new Ri,this._renderTarget.texture.name="anamorphic",this._invSize=ze(new ve),this._textureNode=Fa(this,this._renderTarget.texture),this.updateBeforeType=st.RENDER}getTextureNode(){return this._textureNode}setSize(e,t){this._invSize.value.set(1/e,1/t),e=Math.max(Math.round(e*this.resolution.x),1),t=Math.max(Math.round(t*this.resolution.y),1),this._renderTarget.setSize(e,t)}updateBefore(e){const{renderer:t}=e,n=this.textureNode,s=n.value;this._renderTarget.texture.type=s.type;const r=t.getRenderTarget(),o=n.value;Md.material=this._material,this.setSize(s.image.width,s.image.height),t.setRenderTarget(this._renderTarget),Md.render(t),t.setRenderTarget(r),n.value=o}setup(e){const t=this.textureNode;if(t.isTextureNode!==!0)return console.error("AnamorphNode requires a TextureNode."),Me();const n=t.uvNode||Sn(),s=c=>t.cache().context({getUV:()=>c,forceUVContext:!0}),r=he(()=>{const c=this.samples,l=Math.floor(c/2),u=q(0).toVar();return Kn({start:-l,end:l},({i:d})=>{const h=Z(d).abs().div(l).oneMinus(),p=se(n.x.add(this._invSize.x.mul(d).mul(this.scaleNode)),n.y),g=s(p),_=dm(g,this.tresholdNode).mul(h);u.addAssign(_)}),u.mul(this.colorNode)}),o=this._material||(this._material=e.createNodeMaterial());o.fragmentNode=r();const a=e.getNodeProperties(this);return a.textureNode=t,this._textureNode}}const pA=(i,e=.9,t=3,n=32)=>ce(new fA(ce(i),ce(e),ce(t),n));O("anamorphic",pA);class mA extends ct{constructor(e){super(),this.textureNode=e,this.updateBeforeType=st.RENDER,this._invSize=ze(new ve)}updateBefore(){const e=this.textureNode.value;this._invSize.value.set(1/e.image.width,1/e.image.height)}setup(){const{textureNode:e}=this,t=e.uvNode||Sn(),n=o=>this.textureNode.cache().context({getUV:()=>o,forceUVContext:!0});return he(()=>{const o=this._invSize,a=cn(-1,-2,-1,0,0,0,1,2,1),c=cn(-1,0,1,-2,0,2,-1,0,1),l=Wn(n(t.add(o.mul(se(-1,-1)))).xyz),u=Wn(n(t.add(o.mul(se(-1,0)))).xyz),d=Wn(n(t.add(o.mul(se(-1,1)))).xyz),h=Wn(n(t.add(o.mul(se(0,-1)))).xyz),p=Wn(n(t.add(o.mul(se(0,0)))).xyz),g=Wn(n(t.add(o.mul(se(0,1)))).xyz),_=Wn(n(t.add(o.mul(se(1,-1)))).xyz),m=Wn(n(t.add(o.mul(se(1,0)))).xyz),f=Wn(n(t.add(o.mul(se(1,1)))).xyz),E=yn(a[0][0].mul(l),a[1][0].mul(h),a[2][0].mul(_),a[0][1].mul(u),a[1][1].mul(p),a[2][1].mul(m),a[0][2].mul(d),a[1][2].mul(g),a[2][2].mul(f)),v=yn(c[0][0].mul(l),c[1][0].mul(h),c[2][0].mul(_),c[0][1].mul(u),c[1][1].mul(p),c[2][1].mul(m),c[0][2].mul(d),c[1][2].mul(g),c[2][2].mul(f)),N=E.mul(E).add(v.mul(v)).sqrt();return Me(q(N),1)})()}}const gA=i=>ce(new mA(ce(i)));O("sobel",gA);class _A extends ct{constructor(e,t,n=1,s=.025,r=1){super(),this.textureNode=e,this.viewZNode=t,this.focus=ze(n),this.aperture=ze(s),this.maxblur=ze(r),this._aspect=ze(0),this.updateBeforeType=st.RENDER}updateBefore(){const e=this.textureNode.value;this._aspect.value=e.image.width/e.image.height}setup(){const{textureNode:e}=this,t=e.uvNode||Sn(),n=o=>this.textureNode.uv(o);return he(()=>{const o=se(1,this._aspect),a=this.focus.add(this.viewZNode),c=se(ps(a.mul(this.aperture),this.maxblur.negate(),this.maxblur)),l=c.mul(.9),u=c.mul(.7),d=c.mul(.4);let h=Me(0);return h=h.add(n(t)),h=h.add(n(t.add(se(0,.4).mul(o).mul(c)))),h=h.add(n(t.add(se(.15,.37).mul(o).mul(c)))),h=h.add(n(t.add(se(.29,.29).mul(o).mul(c)))),h=h.add(n(t.add(se(-.37,.15).mul(o).mul(c)))),h=h.add(n(t.add(se(.4,0).mul(o).mul(c)))),h=h.add(n(t.add(se(.37,-.15).mul(o).mul(c)))),h=h.add(n(t.add(se(.29,-.29).mul(o).mul(c)))),h=h.add(n(t.add(se(-.15,-.37).mul(o).mul(c)))),h=h.add(n(t.add(se(0,-.4).mul(o).mul(c)))),h=h.add(n(t.add(se(-.15,.37).mul(o).mul(c)))),h=h.add(n(t.add(se(-.29,.29).mul(o).mul(c)))),h=h.add(n(t.add(se(.37,.15).mul(o).mul(c)))),h=h.add(n(t.add(se(-.4,0).mul(o).mul(c)))),h=h.add(n(t.add(se(-.37,-.15).mul(o).mul(c)))),h=h.add(n(t.add(se(-.29,-.29).mul(o).mul(c)))),h=h.add(n(t.add(se(.15,-.37).mul(o).mul(c)))),h=h.add(n(t.add(se(.15,.37).mul(o).mul(l)))),h=h.add(n(t.add(se(-.37,.15).mul(o).mul(l)))),h=h.add(n(t.add(se(.37,-.15).mul(o).mul(l)))),h=h.add(n(t.add(se(-.15,-.37).mul(o).mul(l)))),h=h.add(n(t.add(se(-.15,.37).mul(o).mul(l)))),h=h.add(n(t.add(se(.37,.15).mul(o).mul(l)))),h=h.add(n(t.add(se(-.37,-.15).mul(o).mul(l)))),h=h.add(n(t.add(se(.15,-.37).mul(o).mul(l)))),h=h.add(n(t.add(se(.29,.29).mul(o).mul(u)))),h=h.add(n(t.add(se(.4,0).mul(o).mul(u)))),h=h.add(n(t.add(se(.29,-.29).mul(o).mul(u)))),h=h.add(n(t.add(se(0,-.4).mul(o).mul(u)))),h=h.add(n(t.add(se(-.29,.29).mul(o).mul(u)))),h=h.add(n(t.add(se(-.4,0).mul(o).mul(u)))),h=h.add(n(t.add(se(-.29,-.29).mul(o).mul(u)))),h=h.add(n(t.add(se(0,.4).mul(o).mul(u)))),h=h.add(n(t.add(se(.29,.29).mul(o).mul(d)))),h=h.add(n(t.add(se(.4,0).mul(o).mul(d)))),h=h.add(n(t.add(se(.29,-.29).mul(o).mul(d)))),h=h.add(n(t.add(se(0,-.4).mul(o).mul(d)))),h=h.add(n(t.add(se(-.29,.29).mul(o).mul(d)))),h=h.add(n(t.add(se(-.4,0).mul(o).mul(d)))),h=h.add(n(t.add(se(-.29,-.29).mul(o).mul(d)))),h=h.add(n(t.add(se(0,.4).mul(o).mul(d)))),h=h.div(41),h.a=1,Me(h)})()}}const xA=(i,e,t,n,s)=>ce(new _A(ce(i),ce(e),t,n,s));O("dof",xA);const Sd=new Kr;class vA extends ct{constructor(e,t=new ve(.5,.5),n=1.57,s=1){super("vec4"),this.colorNode=e,this.center=ze(t),this.angle=ze(n),this.scale=ze(s),this._renderTarget=new Ri,this._renderTarget.texture.name="dotScreen",this._size=ze(new ve),this._textureNode=Fa(this,this._renderTarget.texture),this.updateBeforeType=st.RENDER}getTextureNode(){return this._textureNode}setSize(e,t){this._size.value.set(e,t),this._renderTarget.setSize(e,t)}updateBefore(e){const{renderer:t}=e,n=this.colorNode,s=n.value;this._renderTarget.texture.type=s.type;const r=t.getRenderTarget(),o=n.value;Sd.material=this._material,this.setSize(s.image.width,s.image.height),t.setRenderTarget(this._renderTarget),Sd.render(t),t.setRenderTarget(r),n.value=o}setup(e){const t=this.colorNode,n=he(()=>{const a=Rn(this.angle),c=ni(this.angle),l=Sn().mul(this._size).sub(this.center),u=se(c.mul(l.x).sub(a.mul(l.y)),a.mul(l.x).add(c.mul(l.y))).mul(this.scale);return Rn(u.x).mul(Rn(u.y)).mul(4)}),s=he(()=>{const a=t,c=yn(a.r,a.g,a.b).div(3);return Me(q(c.mul(10).sub(5).add(n())),a.a)}),r=this._material||(this._material=e.createNodeMaterial());r.fragmentNode=s();const o=e.getNodeProperties(this);return o.textureNode=t,this._textureNode}}const yA=(i,e,t,n)=>ce(new vA(ce(i),e,t,n));O("dotScreen",yA);class MA extends ct{constructor(e,t=.005,n=0){super("vec4"),this.textureNode=e,this.amount=ze(t),this.angle=ze(n),this.updateBeforeType=st.RENDER}updateBefore(){}setup(){const{textureNode:e}=this,t=e.uvNode||Sn(),n=r=>this.textureNode.uv(r);return he(()=>{const r=se(ni(this.angle),Rn(this.angle)).mul(this.amount),o=n(t.add(r)),a=n(t),c=n(t.sub(r));return Me(o.r,a.g,c.b,a.a)})()}}const SA=(i,e,t)=>ce(new MA(ce(i),e,t));O("rgbShift",SA);class _m extends ct{constructor(e=null,t={}){super(),this.functionNode=e,this.parameters=t}setParameters(e){return this.parameters=e,this}getParameters(){return this.parameters}getNodeType(e){return this.functionNode.getNodeType(e)}generate(e){const t=[],n=this.functionNode,s=n.getInputs(e),r=this.parameters;if(Array.isArray(r))for(let a=0;a<r.length;a++){const c=s[a],l=r[a];t.push(l.build(e,c.type))}else for(const a of s){const c=r[a.name];if(c!==void 0)t.push(c.build(e,a.type));else throw new Error(`FunctionCallNode: Input '${a.name}' not found in FunctionNode.`)}return`${n.build(e,"property")}( ${t.join(", ")} )`}}const TA=(i,...e)=>(e=e.length>1||e[0]&&e[0].isNode===!0?js(e):wa(e[0]),ce(new _m(ce(i),e)));O("call",TA);te("FunctionCallNode",_m);class xm extends Ie{constructor(e=null){super(),this._value=e,this._cache=null,this.inputType=null,this.outpuType=null,this.events=new Li,this.isScriptableValueNode=!0}get isScriptableOutputNode(){return this.outputType!==null}set value(e){this._value!==e&&(this._cache&&this.inputType==="URL"&&this.value.value instanceof ArrayBuffer&&(URL.revokeObjectURL(this._cache),this._cache=null),this._value=e,this.events.dispatchEvent({type:"change"}),this.refresh())}get value(){return this._value}refresh(){this.events.dispatchEvent({type:"refresh"})}getValue(){const e=this.value;if(e&&this._cache===null&&this.inputType==="URL"&&e.value instanceof ArrayBuffer)this._cache=URL.createObjectURL(new Blob([e.value]));else if(e&&e.value!==null&&e.value!==void 0&&((this.inputType==="URL"||this.inputType==="String")&&typeof e.value=="string"||this.inputType==="Number"&&typeof e.value=="number"||this.inputType==="Vector2"&&e.value.isVector2||this.inputType==="Vector3"&&e.value.isVector3||this.inputType==="Vector4"&&e.value.isVector4||this.inputType==="Color"&&e.value.isColor||this.inputType==="Matrix3"&&e.value.isMatrix3||this.inputType==="Matrix4"&&e.value.isMatrix4))return e.value;return this._cache||e}getNodeType(e){return this.value&&this.value.isNode?this.value.getNodeType(e):"float"}setup(){return this.value&&this.value.isNode?this.value:Z()}serialize(e){super.serialize(e),this.value!==null?this.inputType==="ArrayBuffer"?e.value=Pf(this.value):e.value=this.value?this.value.toJSON(e.meta).uuid:null:e.value=null,e.inputType=this.inputType,e.outputType=this.outputType}deserialize(e){super.deserialize(e);let t=null;e.value!==null&&(e.inputType==="ArrayBuffer"?t=If(e.value):e.inputType==="Texture"?t=e.meta.textures[e.value]:t=e.meta.nodes[e.value]||null),this.value=t,this.inputType=e.inputType,this.outputType=e.outputType}}const qo=B(xm);O("scriptableValue",qo);te("ScriptableValueNode",xm);class vm extends Map{get(e,t=null,...n){if(this.has(e))return super.get(e);if(t!==null){const s=t(...n);return this.set(e,s),s}}}class EA{constructor(e){this.scriptableNode=e}get parameters(){return this.scriptableNode.parameters}get layout(){return this.scriptableNode.getLayout()}getInputLayout(e){return this.scriptableNode.getInputLayout(e)}get(e){const t=this.parameters[e];return t?t.getValue():null}}const Oc=new vm;class ym extends Ie{constructor(e=null,t={}){super(),this.codeNode=e,this.parameters=t,this._local=new vm,this._output=qo(),this._outputs={},this._source=this.source,this._method=null,this._object=null,this._value=null,this._needsOutputUpdate=!0,this.onRefresh=this.onRefresh.bind(this),this.isScriptableNode=!0}get source(){return this.codeNode?this.codeNode.code:""}setLocal(e,t){return this._local.set(e,t)}getLocal(e){return this._local.get(e)}onRefresh(){this._refresh()}getInputLayout(e){for(const t of this.getLayout())if(t.inputType&&(t.id===e||t.name===e))return t}getOutputLayout(e){for(const t of this.getLayout())if(t.outputType&&(t.id===e||t.name===e))return t}setOutput(e,t){const n=this._outputs;return n[e]===void 0?n[e]=qo(t):n[e].value=t,this}getOutput(e){return this._outputs[e]}getParameter(e){return this.parameters[e]}setParameter(e,t){const n=this.parameters;return t&&t.isScriptableNode?(this.deleteParameter(e),n[e]=t,n[e].getDefaultOutput().events.addEventListener("refresh",this.onRefresh)):t&&t.isScriptableValueNode?(this.deleteParameter(e),n[e]=t,n[e].events.addEventListener("refresh",this.onRefresh)):n[e]===void 0?(n[e]=qo(t),n[e].events.addEventListener("refresh",this.onRefresh)):n[e].value=t,this}getValue(){return this.getDefaultOutput().getValue()}deleteParameter(e){let t=this.parameters[e];return t&&(t.isScriptableNode&&(t=t.getDefaultOutput()),t.events.removeEventListener("refresh",this.onRefresh)),this}clearParameters(){for(const e of Object.keys(this.parameters))this.deleteParameter(e);return this.needsUpdate=!0,this}call(e,...t){const s=this.getObject()[e];if(typeof s=="function")return s(...t)}async callAsync(e,...t){const s=this.getObject()[e];if(typeof s=="function")return s.constructor.name==="AsyncFunction"?await s(...t):s(...t)}getNodeType(e){return this.getDefaultOutputNode().getNodeType(e)}refresh(e=null){e!==null?this.getOutput(e).refresh():this._refresh()}getObject(){if(this.needsUpdate&&this.dispose(),this._object!==null)return this._object;const e=()=>this.refresh(),t=(l,u)=>this.setOutput(l,u),n=new EA(this),s=Oc.get("THREE"),r=Oc.get("TSL"),o=this.getMethod(this.codeNode),a=[n,this._local,Oc,e,t,s,r];this._object=o(...a);const c=this._object.layout;if(c&&(c.cache===!1&&this._local.clear(),this._output.outputType=c.outputType||null,Array.isArray(c.elements)))for(const l of c.elements){const u=l.id||l.name;l.inputType&&(this.getParameter(u)===void 0&&this.setParameter(u,null),this.getParameter(u).inputType=l.inputType),l.outputType&&(this.getOutput(u)===void 0&&this.setOutput(u,null),this.getOutput(u).outputType=l.outputType)}return this._object}deserialize(e){super.deserialize(e);for(const t in this.parameters){let n=this.parameters[t];n.isScriptableNode&&(n=n.getDefaultOutput()),n.events.addEventListener("refresh",this.onRefresh)}}getLayout(){return this.getObject().layout}getDefaultOutputNode(){const e=this.getDefaultOutput().value;return e&&e.isNode?e:Z()}getDefaultOutput(){return this._exec()._output}getMethod(){if(this.needsUpdate&&this.dispose(),this._method!==null)return this._method;const e=["parameters","local","global","refresh","setOutput","THREE","TSL"],n=["layout","init","main","dispose"].join(", "),s="var "+n+`; var output = {};
`,r=`
return { ...output, `+n+" };",o=s+this.codeNode.code+r;return this._method=new Function(...e,o),this._method}dispose(){this._method!==null&&(this._object&&typeof this._object.dispose=="function"&&this._object.dispose(),this._method=null,this._object=null,this._source=null,this._value=null,this._needsOutputUpdate=!0,this._output.value=null,this._outputs={})}setup(){return this.getDefaultOutputNode()}set needsUpdate(e){e===!0&&this.dispose()}get needsUpdate(){return this.source!==this._source}_exec(){return this.codeNode===null?this:(this._needsOutputUpdate===!0&&(this._value=this.call("main"),this._needsOutputUpdate=!1),this._output.value=this._value,this)}_refresh(){this.needsUpdate=!0,this._exec(),this._output.refresh()}}const NA=B(ym);O("scriptable",NA);te("ScriptableNode",ym);class za extends Ie{constructor(e,t){super("float"),this.isFogNode=!0,this.colorNode=e,this.factorNode=t}getViewZNode(e){let t;const n=e.context.getViewZ;return n!==void 0&&(t=n(this)),(t||rn.z).negate()}setup(){return this.factorNode}}const AA=B(za);O("fog",AA);te("FogNode",za);class Mm extends za{constructor(e,t,n){super(e),this.isFogRangeNode=!0,this.nearNode=t,this.farNode=n}setup(e){const t=this.getViewZNode(e);return li(this.nearNode,this.farNode,t)}}const wA=B(Mm);O("rangeFog",wA);te("FogRangeNode",Mm);class Sm extends za{constructor(e,t){super(e),this.isFogExp2Node=!0,this.densityNode=t}setup(e){const t=this.getViewZNode(e),n=this.densityNode;return n.mul(n,t,t).negate().exp().oneMinus()}}const bA=B(Sm);O("densityFog",bA);te("FogExp2Node",Sm);let ss=null,rs=null;class Tm extends Ie{constructor(e=Z(),t=Z()){super(),this.minNode=e,this.maxNode=t}getVectorLength(e){const t=e.getTypeLength(Gi(this.minNode.value)),n=e.getTypeLength(Gi(this.maxNode.value));return t>n?t:n}getNodeType(e){return e.object.count>1?e.getTypeFromLength(this.getVectorLength(e)):"float"}setup(e){const t=e.object;let n=null;if(t.count>1){const s=this.minNode.value,r=this.maxNode.value,o=e.getTypeLength(Gi(s)),a=e.getTypeLength(Gi(r));ss=ss||new nt,rs=rs||new nt,ss.setScalar(0),rs.setScalar(0),o===1?ss.setScalar(s):s.isColor?ss.set(s.r,s.g,s.b):ss.set(s.x,s.y,s.z||0,s.w||0),a===1?rs.setScalar(r):r.isColor?rs.set(r.r,r.g,r.b):rs.set(r.x,r.y,r.z||0,r.w||0);const c=4,l=c*t.count,u=new Float32Array(l);for(let h=0;h<l;h++){const p=h%c,g=ss.getComponent(p),_=rs.getComponent(p);u[h]=Ql.lerp(g,_,Math.random())}const d=this.getNodeType(e);if(t.count<=4096)n=Nu(u,"vec4",t.count).element(xu).convert(d);else{const h=new Sf(u,4);e.geometry.setAttribute("__range"+this.id,h),n=Pl(h).convert(d)}}else n=Z(0);return n}}B(Tm);te("RangeNode",Tm);class Em extends Ie{constructor(e,t,n=[64]){super("void"),this.isComputeNode=!0,this.computeNode=e,this.count=t,this.workgroupSize=n,this.dispatchCount=0,this.version=1,this.updateBeforeType=st.OBJECT,this.updateDispatchCount()}dispose(){this.dispatchEvent({type:"dispose"})}set needsUpdate(e){e===!0&&this.version++}updateDispatchCount(){const{count:e,workgroupSize:t}=this;let n=t[0];for(let s=1;s<t.length;s++)n*=t[s];this.dispatchCount=Math.ceil(e/n)}onInit(){}updateBefore({renderer:e}){e.compute(this)}generate(e){const{shaderStage:t}=e;if(t==="compute"){const n=this.computeNode.build(e,"void");n!==""&&e.addLineFlowCode(n)}}}const RA=(i,e,t)=>ce(new Em(ce(i),e,t));O("compute",RA);te("ComputeNode",Em);class gs extends Ie{constructor(e=gs.TARGET_DIRECTION,t=null){super(),this.scope=e,this.light=t}setup(){const{scope:e,light:t}=this;let n=null;return e===gs.TARGET_DIRECTION&&(n=gr.transformDirection(Rl(t).sub(Rl(t.target)))),n}serialize(e){super.serialize(e),e.scope=this.scope}deserialize(e){super.deserialize(e),this.scope=e.scope}}gs.TARGET_DIRECTION="targetDirection";const Nm=B(gs,gs.TARGET_DIRECTION);te("LightNode",gs);const Am=he(i=>{const{lightDistance:e,cutoffDistance:t,decayExponent:n}=i,s=e.pow(n).max(.01).reciprocal();return t.greaterThan(0).cond(s.mul(e.div(t).pow4().oneMinus().clamp().pow2()),s)});class wm extends Ki{constructor(e=null){super(e),this.cutoffDistanceNode=ze(0),this.decayExponentNode=ze(0)}update(e){const{light:t}=this;super.update(e),this.cutoffDistanceNode.value=t.distance,this.decayExponentNode.value=t.decay}setup(e){const{colorNode:t,cutoffDistanceNode:n,decayExponentNode:s,light:r}=this,o=e.context.lightingModel,a=Au(r).sub(rn),c=a.normalize(),l=a.length(),u=Am({lightDistance:l,cutoffDistance:n,decayExponent:s}),d=t.mul(u),h=e.context.reflectedLight;o.direct({lightDirection:c,lightColor:d,reflectedLight:h,shadowMask:this.shadowMaskNode},e.stack,e)}}te("PointLightNode",wm);ys(UM,wm);class bm extends Ki{constructor(e=null){super(e)}setup(e){super.setup(e);const t=e.context.lightingModel,n=this.colorNode,s=Nm(this.light),r=e.context.reflectedLight;t.direct({lightDirection:s,lightColor:n,reflectedLight:r,shadowMask:this.shadowMaskNode},e.stack,e)}}te("DirectionalLightNode",bm);ys(bf,bm);const Fc=new xt,Lo=new xt;let Po,zc;class Rm extends Ki{constructor(e=null){super(e),this.halfHeight=ze(new L),this.halfWidth=ze(new L)}update(e){super.update(e);const{light:t}=this,n=e.camera.matrixWorldInverse;Lo.identity(),Fc.copy(t.matrixWorld),Fc.premultiply(n),Lo.extractRotation(Fc),this.halfWidth.value.set(t.width*.5,0,0),this.halfHeight.value.set(0,t.height*.5,0),this.halfWidth.value.applyMatrix4(Lo),this.halfHeight.value.applyMatrix4(Lo)}setup(e){super.setup(e),Po===void 0&&(e.isAvailable("float32Filterable")?(Po=Kt(pe.LTC_FLOAT_1),zc=Kt(pe.LTC_FLOAT_2)):(Po=Kt(pe.LTC_HALF_1),zc=Kt(pe.LTC_HALF_2)));const{colorNode:t,light:n}=this,s=e.context.lightingModel,r=Au(n),o=e.context.reflectedLight;s.directRectArea({lightColor:t,lightPosition:r,halfWidth:this.halfWidth,halfHeight:this.halfHeight,reflectedLight:o,ltc_1:Po,ltc_2:zc},e.stack,e)}}te("RectAreaLightNode",Rm);ys(FM,Rm);class Cu extends Ki{constructor(e=null){super(e),this.coneCosNode=ze(0),this.penumbraCosNode=ze(0),this.cutoffDistanceNode=ze(0),this.decayExponentNode=ze(0)}update(e){super.update(e);const{light:t}=this;this.coneCosNode.value=Math.cos(t.angle),this.penumbraCosNode.value=Math.cos(t.angle*(1-t.penumbra)),this.cutoffDistanceNode.value=t.distance,this.decayExponentNode.value=t.decay}getSpotAttenuation(e){const{coneCosNode:t,penumbraCosNode:n}=this;return li(t,n,e)}setup(e){super.setup(e);const t=e.context.lightingModel,{colorNode:n,cutoffDistanceNode:s,decayExponentNode:r,light:o}=this,a=Au(o).sub(rn),c=a.normalize(),l=c.dot(Nm(o)),u=this.getSpotAttenuation(l),d=a.length(),h=Am({lightDistance:d,cutoffDistance:s,decayExponent:r}),p=n.mul(u).mul(h),g=e.context.reflectedLight;t.direct({lightDirection:c,lightColor:p,reflectedLight:g,shadowMask:this.shadowMaskNode},e.stack,e)}}te("SpotLightNode",Cu);ys(wf,Cu);class Cm extends Cu{getSpotAttenuation(e){const t=this.light.iesMap;let n=null;if(t&&t.isTexture===!0){const s=e.acos().mul(1/Math.PI);n=Kt(t,se(s,0),0).r}else n=super.getSpotAttenuation(e);return n}}te("IESSpotLightNode",Cm);ys(kM,Cm);class Lm extends Ki{constructor(e=null){super(e)}setup({context:e}){e.irradiance.addAssign(this.colorNode)}}te("AmbientLightNode",Lm);ys(Rf,Lm);class Pm extends Ki{constructor(e=null){super(e),this.lightPositionNode=Rl(e),this.lightDirectionNode=this.lightPositionNode.normalize(),this.groundColorNode=ze(new Ue)}update(e){const{light:t}=this;super.update(e),this.lightPositionNode.object3d=t,this.groundColorNode.value.copy(t.groundColor).multiplyScalar(t.intensity)}setup(e){const{colorNode:t,groundColorNode:n,lightDirectionNode:s}=this,o=$i.dot(s).mul(.5).add(.5),a=Ft(n,t,o);e.context.irradiance.addAssign(a)}}te("HemisphereLightNode",Pm);ys(PM,Pm);const CA=he(i=>{const e=i.uv.mul(2),t=e.x.floor(),n=e.y.floor();return t.add(n).mod(2).sign()});class Im extends ct{constructor(e=Sn()){super("float"),this.uvNode=e}setup(){return CA({uv:this.uvNode})}}const LA=B(Im);O("checker",LA);te("CheckerNode",Im);const PA=new Tf;class IA extends ln{constructor(e={}){super(),this.normals=!1,this.lights=!1,this.useAlphaToCoverage=!0,this.useColor=e.vertexColors,this.pointWidth=1,this.pointColorNode=null,this.setDefaultValues(PA),this.setupShaders(),this.setValues(e)}setupShaders(){const e=this.alphaToCoverage,t=this.useColor;this.vertexNode=he(()=>{Ot(se(),"vUv").assign(Sn());const n=nn("instancePosition"),s=Et("vec4","mvPos");s.assign(ms.mul(Me(n,1)));const r=er.z.div(er.w),o=si.mul(s),a=Et("vec2","offset");return a.assign(dn.xy),a.assign(a.mul(yE)),a.assign(a.div(er.z)),a.y.assign(a.y.mul(r)),a.assign(a.mul(o.w)),o.assign(o.add(Me(a,0,0))),o})(),this.fragmentNode=he(()=>{const n=Ot(se(),"vUv"),s=Et("float","alpha");s.assign(1);const r=n.x,o=n.y,a=r.mul(r).add(o.mul(o));if(e){const l=Et("float","dlen");l.assign(a.fwidth()),s.assign(li(l.oneMinus(),l.add(1),a).oneMinus())}else a.greaterThan(1).discard();let c;return this.pointColorNode?c=this.pointColorNode:t?c=nn("instanceColor").mul(Vr):c=Vr,Me(c,s)})(),this.needsUpdate=!0}get alphaToCoverage(){return this.useAlphaToCoverage}set alphaToCoverage(e){this.useAlphaToCoverage!==e&&(this.useAlphaToCoverage=e,this.setupShaders())}}qt("InstancedPointsNodeMaterial",IA);const DA=new ya;class UA extends ln{constructor(e){super(),this.isLineBasicNodeMaterial=!0,this.lights=!1,this.normals=!1,this.setDefaultValues(DA),this.setValues(e)}}qt("LineBasicNodeMaterial",UA);const OA=new Af;class FA extends ln{constructor(e){super(),this.isLineDashedNodeMaterial=!0,this.lights=!1,this.normals=!1,this.setDefaultValues(OA),this.offsetNode=null,this.dashScaleNode=null,this.dashSizeNode=null,this.gapSizeNode=null,this.setValues(e)}setupVariants(){const e=this.offsetNode,t=this.dashScaleNode?Z(this.dashScaleNode):Cl,n=this.dashSizeNode?Z(this.dashSizeNode):mp,s=this.dashSizeNode?Z(this.dashGapNode):gp;Js.assign(n),ra.assign(s);const r=Ot(nn("lineDistance").mul(t));(e?r.add(e):r).mod(Js.add(ra)).greaterThan(Js).discard()}}qt("LineDashedNodeMaterial",FA);const zA=new Af;class BA extends ln{constructor(e={}){super(),this.normals=!1,this.lights=!1,this.setDefaultValues(zA),this.useAlphaToCoverage=!0,this.useColor=e.vertexColors,this.useDash=e.dashed,this.useWorldUnits=!1,this.dashOffset=0,this.lineWidth=1,this.lineColorNode=null,this.offsetNode=null,this.dashScaleNode=null,this.dashSizeNode=null,this.gapSizeNode=null,this.setValues(e)}setup(e){this.setupShaders(),super.setup(e)}setupShaders(){const e=this.alphaToCoverage,t=this.useColor,n=this.dashed,s=this.worldUnits,r=he(({start:a,end:c})=>{const l=si.element(2).element(2),h=si.element(3).element(2).mul(-.5).div(l).sub(a.z).div(c.z.sub(a.z));return Me(Ft(a.xyz,c.xyz,h),c.w)});this.vertexNode=he(()=>{ei("vec2","vUv").assign(Sn());const a=nn("instanceStart"),c=nn("instanceEnd"),l=Et("vec4","start"),u=Et("vec4","end");l.assign(ms.mul(Me(a,1))),u.assign(ms.mul(Me(c,1))),s&&(ei("vec3","worldStart").assign(l.xyz),ei("vec3","worldEnd").assign(u.xyz));const d=er.z.div(er.w),h=si.element(2).element(3).equal(-1);Lt(h,()=>{Lt(l.z.lessThan(0).and(u.z.greaterThan(0)),()=>{u.assign(r({start:l,end:u}))}).elseif(u.z.lessThan(0).and(l.z.greaterThanEqual(0)),()=>{l.assign(r({start:u,end:l}))})});const p=si.mul(l),g=si.mul(u),_=p.xyz.div(p.w),m=g.xyz.div(g.w),f=m.xy.sub(_.xy).temp();f.x.assign(f.x.mul(d)),f.assign(f.normalize());const E=ta(Me());if(s){const v=u.xyz.sub(l.xyz).normalize(),N=Ft(l.xyz,u.xyz,.5).normalize(),D=v.cross(N).normalize(),b=v.cross(D),A=ei("vec4","worldPos");A.assign(dn.y.lessThan(.5).cond(l,u));const P=Sc.mul(.5);A.addAssign(Me(dn.x.lessThan(0).cond(D.mul(P),D.mul(P).negate()),0)),n||(A.addAssign(Me(dn.y.lessThan(.5).cond(v.mul(P).negate(),v.mul(P)),0)),A.addAssign(Me(b.mul(P),0)),Lt(dn.y.greaterThan(1).or(dn.y.lessThan(0)),()=>{A.subAssign(Me(b.mul(2).mul(P),0))})),E.assign(si.mul(A));const T=ta(q());T.assign(dn.y.lessThan(.5).cond(_,m)),E.z.assign(T.z.mul(E.w))}else{const v=Et("vec2","offset");v.assign(se(f.y,f.x.negate())),f.x.assign(f.x.div(d)),v.x.assign(v.x.div(d)),v.assign(dn.x.lessThan(0).cond(v.negate(),v)),Lt(dn.y.lessThan(0),()=>{v.assign(v.sub(f))}).elseif(dn.y.greaterThan(1),()=>{v.assign(v.add(f))}),v.assign(v.mul(Sc)),v.assign(v.div(er.w)),E.assign(dn.y.lessThan(.5).cond(p,g)),v.assign(v.mul(E.w)),E.assign(E.add(Me(v,0,0)))}return E})();const o=he(({p1:a,p2:c,p3:l,p4:u})=>{const d=a.sub(l),h=u.sub(l),p=c.sub(a),g=d.dot(h),_=h.dot(p),m=d.dot(p),f=h.dot(h),v=p.dot(p).mul(f).sub(_.mul(_)),D=g.mul(_).sub(m.mul(f)).div(v).clamp(),b=g.add(_.mul(D)).div(f).clamp();return se(D,b)});this.fragmentNode=he(()=>{const a=ei("vec2","vUv");if(n){const u=this.offsetNode?Z(this.offsetNodeNode):nd,d=this.dashScaleNode?Z(this.dashScaleNode):Cl,h=this.dashSizeNode?Z(this.dashSizeNode):mp,p=this.dashSizeNode?Z(this.dashGapNode):gp;Js.assign(h),ra.assign(p);const g=nn("instanceDistanceStart"),_=nn("instanceDistanceEnd"),m=dn.y.lessThan(.5).cond(d.mul(g),Cl.mul(_)),f=Ot(m.add(nd)),E=u?f.add(u):f;a.y.lessThan(-1).or(a.y.greaterThan(1)).discard(),E.mod(Js.add(ra)).greaterThan(Js).discard()}const c=Et("float","alpha");if(c.assign(1),s){const u=ei("vec3","worldStart"),d=ei("vec3","worldEnd"),h=ei("vec4","worldPos").xyz.normalize().mul(1e5),p=d.sub(u),g=o({p1:u,p2:d,p3:q(0,0,0),p4:h}),_=u.add(p.mul(g.x)),m=h.mul(g.y),v=_.sub(m).length().div(Sc);if(!n)if(e){const N=v.fwidth();c.assign(li(N.negate().add(.5),N.add(.5),v).oneMinus())}else v.greaterThan(.5).discard()}else if(e){const u=a.x,d=a.y.greaterThan(0).cond(a.y.sub(1),a.y.add(1)),h=u.mul(u).add(d.mul(d)),p=Et("float","dlen");p.assign(h.fwidth()),Lt(a.y.abs().greaterThan(1),()=>{c.assign(li(p.oneMinus(),p.add(1),h).oneMinus())})}else Lt(a.y.abs().greaterThan(1),()=>{const u=a.x,d=a.y.greaterThan(0).cond(a.y.sub(1),a.y.add(1));u.mul(u).add(d.mul(d)).greaterThan(1).discard()});let l;if(this.lineColorNode)l=this.lineColorNode;else if(t){const u=nn("instanceColorStart"),d=nn("instanceColorEnd");l=dn.y.lessThan(.5).cond(u,d).mul(Vr)}else l=Vr;return Me(l,c)})()}get worldUnits(){return this.useWorldUnits}set worldUnits(e){this.useWorldUnits!==e&&(this.useWorldUnits=e,this.needsUpdate=!0)}get dashed(){return this.useDash}set dashed(e){this.useDash!==e&&(this.useDash=e,this.needsUpdate=!0)}get alphaToCoverage(){return this.useAlphaToCoverage}set alphaToCoverage(e){this.useAlphaToCoverage!==e&&(this.useAlphaToCoverage=e,this.needsUpdate=!0)}}qt("Line2NodeMaterial",BA);const VA=new AM;class HA extends ln{constructor(e){super(),this.lights=!1,this.isMeshNormalNodeMaterial=!0,this.setDefaultValues(VA),this.setValues(e)}setupDiffuseColor(){const e=this.opacityNode?Z(this.opacityNode):pp;_t.assign(Me(Zp(Rt),e))}}qt("MeshNormalNodeMaterial",HA);const kA=new _a;class GA extends ln{constructor(e){super(),this.isMeshBasicNodeMaterial=!0,this.lights=!1,this.setDefaultValues(kA),this.setValues(e)}}qt("MeshBasicNodeMaterial",GA);const kr=he(({f0:i,f90:e,dotVH:t})=>{const n=t.mul(-5.55473).sub(6.98316).mul(t).exp2();return i.mul(n.oneMinus()).add(e.mul(n))}),lr=he(i=>i.diffuseColor.mul(1/Math.PI)),WA=()=>Z(.25),XA=he(({dotNH:i})=>Nl.mul(Z(.5)).add(1).mul(Z(1/Math.PI)).mul(i.pow(Nl))),qA=he(({lightDirection:i})=>{const e=i.add(Tt).normalize(),t=Rt.dot(e).clamp(),n=Tt.dot(e).clamp(),s=kr({f0:bn,f90:1,dotVH:n}),r=WA(),o=XA({dotNH:t});return s.mul(r).mul(o)});class Dm extends ba{constructor(e=!0){super(),this.specular=e}direct({lightDirection:e,lightColor:t,reflectedLight:n}){const r=Rt.dot(e).clamp().mul(t);n.directDiffuse.addAssign(r.mul(lr({diffuseColor:_t.rgb}))),this.specular===!0&&n.directSpecular.addAssign(r.mul(qA({lightDirection:e})).mul(tE))}indirectDiffuse({irradiance:e,reflectedLight:t}){t.indirectDiffuse.addAssign(e.mul(lr({diffuseColor:_t})))}}const YA=new wM;class $A extends ln{constructor(e){super(),this.isMeshLambertNodeMaterial=!0,this.lights=!0,this.setDefaultValues(YA),this.setValues(e)}setupLightingModel(){return new Dm(!1)}}qt("MeshLambertNodeMaterial",$A);const jA=new Nf;class KA extends ln{constructor(e){super(),this.isMeshPhongNodeMaterial=!0,this.lights=!0,this.shininessNode=null,this.specularNode=null,this.setDefaultValues(jA),this.setValues(e)}setupLightingModel(){return new Dm}setupVariants(){const e=(this.shininessNode?Z(this.shininessNode):ZT).max(1e-4);Nl.assign(e);const t=this.specularNode||QT;bn.assign(t)}copy(e){return this.shininessNode=e.shininessNode,this.specularNode=e.specularNode,super.copy(e)}}qt("MeshPhongNodeMaterial",KA);const ZA=he(()=>{const i=aa.dFdx().abs().max(aa.dFdy().abs());return i.x.max(i.y).max(i.z)}),Um=he(i=>{const{roughness:e}=i,t=ZA();let n=e.max(.0525);return n=n.add(t),n=n.min(1),n}),JA=he(({alpha:i,dotNL:e,dotNV:t})=>{const n=i.pow2(),s=e.mul(n.add(n.oneMinus().mul(t.pow2())).sqrt()),r=t.mul(n.add(n.oneMinus().mul(e.pow2())).sqrt());return Ci(.5,s.add(r).max(Zf))}).setLayout({name:"V_GGX_SmithCorrelated",type:"float",inputs:[{name:"alpha",type:"float"},{name:"dotNL",type:"float"},{name:"dotNV",type:"float"}]}),QA=he(({alphaT:i,alphaB:e,dotTV:t,dotBV:n,dotTL:s,dotBL:r,dotNV:o,dotNL:a})=>{const c=a.mul(q(i.mul(t),e.mul(n),o).length()),l=o.mul(q(i.mul(s),e.mul(r),a).length());return Ci(.5,c.add(l)).saturate()}).setLayout({name:"V_GGX_SmithCorrelated_Anisotropic",type:"float",inputs:[{name:"alphaT",type:"float",qualifier:"in"},{name:"alphaB",type:"float",qualifier:"in"},{name:"dotTV",type:"float",qualifier:"in"},{name:"dotBV",type:"float",qualifier:"in"},{name:"dotTL",type:"float",qualifier:"in"},{name:"dotBL",type:"float",qualifier:"in"},{name:"dotNV",type:"float",qualifier:"in"},{name:"dotNL",type:"float",qualifier:"in"}]}),ew=he(({alpha:i,dotNH:e})=>{const t=i.pow2(),n=e.pow2().mul(t.oneMinus()).oneMinus();return t.div(n.pow2()).mul(1/Math.PI)}).setLayout({name:"D_GGX",type:"float",inputs:[{name:"alpha",type:"float"},{name:"dotNH",type:"float"}]}),tw=Z(1/Math.PI),nw=he(({alphaT:i,alphaB:e,dotNH:t,dotTH:n,dotBH:s})=>{const r=i.mul(e),o=q(e.mul(n),i.mul(s),r.mul(t)),a=o.dot(o),c=r.div(a);return tw.mul(r.mul(c.pow2()))}).setLayout({name:"D_GGX_Anisotropic",type:"float",inputs:[{name:"alphaT",type:"float",qualifier:"in"},{name:"alphaB",type:"float",qualifier:"in"},{name:"dotNH",type:"float",qualifier:"in"},{name:"dotTH",type:"float",qualifier:"in"},{name:"dotBH",type:"float",qualifier:"in"}]}),Td=he(i=>{const{lightDirection:e,f0:t,f90:n,roughness:s,f:r,USE_IRIDESCENCE:o,USE_ANISOTROPY:a}=i,c=i.normalView||Rt,l=s.pow2(),u=e.add(Tt).normalize(),d=c.dot(e).clamp(),h=c.dot(Tt).clamp(),p=c.dot(u).clamp(),g=Tt.dot(u).clamp();let _=kr({f0:t,f90:n,dotVH:g}),m,f;if(Kh(o)&&(_=yu.mix(_,r)),Kh(a)){const E=Go.dot(e),v=Go.dot(Tt),N=Go.dot(u),D=Zs.dot(e),b=Zs.dot(Tt),A=Zs.dot(u);m=QA({alphaT:El,alphaB:l,dotTV:v,dotBV:b,dotTL:E,dotBL:D,dotNV:h,dotNL:d}),f=nw({alphaT:El,alphaB:l,dotNH:p,dotTH:N,dotBH:A})}else m=JA({alpha:l,dotNL:d,dotNV:h}),f=ew({alpha:l,dotNH:p});return _.mul(m).mul(f)}),Om=he(({roughness:i,dotNV:e})=>{const t=Me(-1,-.0275,-.572,.022),n=Me(1,.0425,1.04,-.04),s=i.mul(t).add(n),r=s.x.mul(s.x).min(e.mul(-9.28).exp2()).mul(s.x).add(s.y);return se(-1.04,1.04).mul(r).add(s.zw)}).setLayout({name:"DFGApprox",type:"vec2",inputs:[{name:"roughness",type:"float"},{name:"dotNV",type:"vec3"}]}),Fm=he(i=>{const{dotNV:e,specularColor:t,specularF90:n,roughness:s}=i,r=Om({dotNV:e,roughness:s});return t.mul(r.x).add(n.mul(r.y))}),iw=he(({f:i,f90:e,dotVH:t})=>{const n=t.oneMinus().saturate(),s=n.mul(n),r=n.mul(s,s).clamp(0,.9999);return i.sub(q(e).mul(r)).div(r.oneMinus())}).setLayout({name:"Schlick_to_F0",type:"vec3",inputs:[{name:"f",type:"vec3"},{name:"f90",type:"float"},{name:"dotVH",type:"float"}]}),sw=he(({roughness:i,dotNH:e})=>{const t=i.pow2(),n=Z(1).div(t),r=e.pow2().oneMinus().max(.0078125);return Z(2).add(n).mul(r.pow(n.mul(.5))).div(2*Math.PI)}).setLayout({name:"D_Charlie",type:"float",inputs:[{name:"roughness",type:"float"},{name:"dotNH",type:"float"}]}),rw=he(({dotNV:i,dotNL:e})=>Z(1).div(Z(4).mul(e.add(i).sub(e.mul(i))))).setLayout({name:"V_Neubelt",type:"float",inputs:[{name:"dotNV",type:"float"},{name:"dotNL",type:"float"}]}),ow=he(({lightDirection:i})=>{const e=i.add(Tt).normalize(),t=Rt.dot(i).clamp(),n=Rt.dot(Tt).clamp(),s=Rt.dot(e).clamp(),r=sw({roughness:vu,dotNH:s}),o=rw({dotNV:n,dotNL:t});return Ws.mul(r).mul(o)}),aw=he(({N:i,V:e,roughness:t})=>{const r=.0078125,o=i.dot(e).saturate(),a=se(t,o.oneMinus().sqrt());return a.assign(a.mul(.984375).add(r)),a}).setLayout({name:"LTC_Uv",type:"vec2",inputs:[{name:"N",type:"vec3"},{name:"V",type:"vec3"},{name:"roughness",type:"float"}]}),cw=he(({f:i})=>{const e=i.length();return fn(e.mul(e).add(i.z).div(e.add(1)),0)}).setLayout({name:"LTC_ClippedSphereFormFactor",type:"float",inputs:[{name:"f",type:"vec3"}]}),Io=he(({v1:i,v2:e})=>{const t=i.dot(e),n=t.abs().toVar(),s=n.mul(.0145206).add(.4965155).mul(n).add(.8543985).toVar(),r=n.add(4.1616724).mul(n).add(3.417594).toVar(),o=s.div(r),a=t.greaterThan(0).cond(o,fn(t.mul(t).oneMinus(),1e-7).inverseSqrt().mul(.5).sub(o));return i.cross(e).mul(a)}).setLayout({name:"LTC_EdgeVectorFormFactor",type:"vec3",inputs:[{name:"v1",type:"vec3"},{name:"v2",type:"vec3"}]}),Ed=he(({N:i,V:e,P:t,mInv:n,p0:s,p1:r,p2:o,p3:a})=>{const c=r.sub(s).toVar(),l=a.sub(s).toVar(),u=c.cross(l),d=q().toVar();return Lt(u.dot(t.sub(s)).greaterThanEqual(0),()=>{const h=e.sub(i.mul(e.dot(i))).normalize(),p=i.cross(h).negate(),g=n.mul(cn(h,p,i).transpose()).toVar(),_=g.mul(s.sub(t)).normalize().toVar(),m=g.mul(r.sub(t)).normalize().toVar(),f=g.mul(o.sub(t)).normalize().toVar(),E=g.mul(a.sub(t)).normalize().toVar(),v=q(0).toVar();v.addAssign(Io({v1:_,v2:m})),v.addAssign(Io({v1:m,v2:f})),v.addAssign(Io({v1:f,v2:E})),v.addAssign(Io({v1:E,v2:_})),d.assign(q(cw({f:v})))}),d}).setLayout({name:"LTC_Evaluate",type:"vec3",inputs:[{name:"N",type:"vec3"},{name:"V",type:"vec3"},{name:"P",type:"vec3"},{name:"mInv",type:"mat3"},{name:"p0",type:"vec3"},{name:"p1",type:"vec3"},{name:"p2",type:"vec3"},{name:"p3",type:"vec3"}]}),Nd=he(([i,e,t,n,s])=>{const r=q(sp(e.negate(),zr(i),Ci(1,n))),o=q(Qs(s[0].xyz),Qs(s[1].xyz),Qs(s[2].xyz));return zr(r).mul(t.mul(o))}).setLayout({name:"getVolumeTransmissionRay",type:"vec3",inputs:[{name:"n",type:"vec3"},{name:"v",type:"vec3"},{name:"thickness",type:"float"},{name:"ior",type:"float"},{name:"modelMatrix",type:"mat4"}]}),lw=he(([i,e])=>i.mul(ps(e.mul(2).sub(2),0,1))).setLayout({name:"applyIorToRoughness",type:"float",inputs:[{name:"roughness",type:"float"},{name:"ior",type:"float"}]}),uw=Up(),Ad=he(([i,e,t])=>{const n=uw.uv(i),s=Ra(Z(Ul.x)).mul(lw(e,t));return n.bicubic(s)}),wd=he(([i,e,t])=>(Lt(t.notEqual(0),()=>{const n=ep(e).negate().div(t);return Qf(n.negate().mul(i))}),q(1))).setLayout({name:"volumeAttenuation",type:"vec3",inputs:[{name:"transmissionDistance",type:"float"},{name:"attenuationColor",type:"vec3"},{name:"attenuationDistance",type:"float"}]}),hw=he(([i,e,t,n,s,r,o,a,c,l,u,d,h,p,g])=>{let _,m;if(g){_=Me().toVar(),m=q().toVar();const D=u.sub(1).mul(g.mul(.025)),b=q(u.sub(D),u,u.add(D));Kn({start:0,end:3},({i:A})=>{const P=b.element(A),T=Nd(i,e,d,P,a),M=o.add(T),C=l.mul(c.mul(Me(M,1))),G=se(C.xy.div(C.w)).toVar();G.addAssign(1),G.divAssign(2),G.assign(se(G.x,G.y.oneMinus()));const H=Ad(G,t,P);_.element(A).assign(H.element(A)),_.a.addAssign(H.a),m.element(A).assign(n.element(A).mul(wd(Qs(T),h,p).element(A)))}),_.a.divAssign(3)}else{const D=Nd(i,e,d,u,a),b=o.add(D),A=l.mul(c.mul(Me(b,1))),P=se(A.xy.div(A.w)).toVar();P.addAssign(1),P.divAssign(2),P.assign(se(P.x,P.y.oneMinus())),_=Ad(P,t,u),m=n.mul(wd(Qs(D),h,p))}const f=m.rgb.mul(_.rgb),E=i.dot(e).clamp(),v=q(Fm({dotNV:E,specularColor:s,specularF90:r,roughness:t})),N=m.r.add(m.g,m.b).div(3);return Me(v.oneMinus().mul(f),_.a.oneMinus().mul(N).oneMinus())}),dw=cn(3.2404542,-.969266,.0556434,-1.5371385,1.8760108,-.2040259,-.4985314,.041556,1.0572252),fw=i=>{const e=i.sqrt();return q(1).add(e).div(q(1).sub(e))},bd=(i,e)=>i.sub(e).div(i.add(e)).pow2(),pw=(i,e)=>{const t=i.mul(2*Math.PI*1e-9),n=q(54856e-17,44201e-17,52481e-17),s=q(1681e3,1795300,2208400),r=q(43278e5,93046e5,66121e5),o=Z(9747e-17*Math.sqrt(2*Math.PI*45282e5)).mul(t.mul(2239900).add(e.x).cos()).mul(t.pow2().mul(-45282e5).exp());let a=n.mul(r.mul(2*Math.PI).sqrt()).mul(s.mul(t).add(e).cos()).mul(t.pow2().negate().mul(r).exp());return a=q(a.x.add(o),a.y,a.z).div(10685e-11),dw.mul(a)},mw=he(({outsideIOR:i,eta2:e,cosTheta1:t,thinFilmThickness:n,baseF0:s})=>{const r=Ft(i,e,li(0,.03,n)),o=i.div(r).pow2().mul(Z(1).sub(t.pow2())),c=Z(1).sub(o).sqrt(),l=bd(r,i),u=kr({f0:l,f90:1,dotVH:t}),d=u.oneMinus(),h=r.lessThan(i).cond(Math.PI,0),p=Z(Math.PI).sub(h),g=fw(s.clamp(0,.9999)),_=bd(g,r.toVec3()),m=kr({f0:_,f90:1,dotVH:c}),f=q(g.x.lessThan(r).cond(Math.PI,0),g.y.lessThan(r).cond(Math.PI,0),g.z.lessThan(r).cond(Math.PI,0)),E=r.mul(n,c,2),v=q(p).add(f),N=u.mul(m).clamp(1e-5,.9999),D=N.sqrt(),b=d.pow2().mul(m).div(q(1).sub(N));let P=u.add(b),T=b.sub(d);for(let M=1;M<=2;++M){T=T.mul(D);const C=pw(Z(M).mul(E),Z(M).mul(v)).mul(2);P=P.add(T.mul(C))}return P.max(q(0))}).setLayout({name:"evalIridescence",type:"vec3",inputs:[{name:"outsideIOR",type:"float"},{name:"eta2",type:"float"},{name:"cosTheta1",type:"float"},{name:"thinFilmThickness",type:"float"},{name:"baseF0",type:"vec3"}]}),gw=he(({normal:i,viewDir:e,roughness:t})=>{const n=i.dot(e).saturate(),s=t.pow2(),r=Un(t.lessThan(.25),Z(-339.2).mul(s).add(Z(161.4).mul(t)).sub(25.9),Z(-8.48).mul(s).add(Z(14.3).mul(t)).sub(9.95)),o=Un(t.lessThan(.25),Z(44).mul(s).sub(Z(23.7).mul(t)).add(3.26),Z(1.97).mul(s).sub(Z(3.27).mul(t)).add(.72));return Un(t.lessThan(.25),0,Z(.1).mul(t).sub(.025)).add(r.mul(n).add(o).exp()).mul(1/Math.PI).saturate()}),Bc=q(.04),Vc=Z(1);class Lu extends ba{constructor(e=!1,t=!1,n=!1,s=!1,r=!1,o=!1){super(),this.clearcoat=e,this.sheen=t,this.iridescence=n,this.anisotropy=s,this.transmission=r,this.dispersion=o,this.clearcoatRadiance=null,this.clearcoatSpecularDirect=null,this.clearcoatSpecularIndirect=null,this.sheenSpecularDirect=null,this.sheenSpecularIndirect=null,this.iridescenceFresnel=null,this.iridescenceF0=null}start(e){if(this.clearcoat===!0&&(this.clearcoatRadiance=q().temp("clearcoatRadiance"),this.clearcoatSpecularDirect=q().temp("clearcoatSpecularDirect"),this.clearcoatSpecularIndirect=q().temp("clearcoatSpecularIndirect")),this.sheen===!0&&(this.sheenSpecularDirect=q().temp("sheenSpecularDirect"),this.sheenSpecularIndirect=q().temp("sheenSpecularIndirect")),this.iridescence===!0){const t=Rt.dot(Tt).clamp();this.iridescenceFresnel=mw({outsideIOR:Z(1),eta2:Wf,cosTheta1:t,thinFilmThickness:Xf,baseF0:bn}),this.iridescenceF0=iw({f:this.iridescenceFresnel,f90:1,dotVH:t})}if(this.transmission===!0){const t=Ll,n=hp.sub(Ll).normalize(),s=fp;e.backdrop=hw(s,n,Si,_t,bn,sa,t,Br,gr,si,Wo,qf,$f,Yf,this.dispersion?jf:null),e.backdropAlpha=Al,_t.a.mulAssign(Ft(1,e.backdrop.a,Al))}}computeMultiscattering(e,t,n){const s=Rt.dot(Tt).clamp(),r=Om({roughness:Si,dotNV:s}),a=(this.iridescenceF0?yu.mix(bn,this.iridescenceF0):bn).mul(r.x).add(n.mul(r.y)),l=r.x.add(r.y).oneMinus(),u=bn.add(bn.oneMinus().mul(.047619)),d=a.mul(u).div(l.mul(u).oneMinus());e.addAssign(a),t.addAssign(d.mul(l))}direct({lightDirection:e,lightColor:t,reflectedLight:n}){const r=Rt.dot(e).clamp().mul(t);if(this.sheen===!0&&this.sheenSpecularDirect.addAssign(r.mul(ow({lightDirection:e}))),this.clearcoat===!0){const a=Xs.dot(e).clamp().mul(t);this.clearcoatSpecularDirect.addAssign(a.mul(Td({lightDirection:e,f0:Bc,f90:Vc,roughness:ia,normalView:Xs})))}n.directDiffuse.addAssign(r.mul(lr({diffuseColor:_t.rgb}))),n.directSpecular.addAssign(r.mul(Td({lightDirection:e,f0:bn,f90:1,roughness:Si,iridescence:this.iridescence,f:this.iridescenceFresnel,USE_IRIDESCENCE:this.iridescence,USE_ANISOTROPY:this.anisotropy})))}directRectArea({lightColor:e,lightPosition:t,halfWidth:n,halfHeight:s,reflectedLight:r,ltc_1:o,ltc_2:a}){const c=t.add(n).sub(s),l=t.sub(n).sub(s),u=t.sub(n).add(s),d=t.add(n).add(s),h=Rt,p=Tt,g=rn.toVar(),_=aw({N:h,V:p,roughness:Si}),m=o.uv(_).toVar(),f=a.uv(_).toVar(),E=cn(q(m.x,0,m.y),q(0,1,0),q(m.z,0,m.w)).toVar(),v=bn.mul(f.x).add(bn.oneMinus().mul(f.y)).toVar();r.directSpecular.addAssign(e.mul(v).mul(Ed({N:h,V:p,P:g,mInv:E,p0:c,p1:l,p2:u,p3:d}))),r.directDiffuse.addAssign(e.mul(_t).mul(Ed({N:h,V:p,P:g,mInv:cn(1,0,0,0,1,0,0,0,1),p0:c,p1:l,p2:u,p3:d})))}indirectDiffuse({irradiance:e,reflectedLight:t}){t.indirectDiffuse.addAssign(e.mul(lr({diffuseColor:_t})))}indirectSpecular({radiance:e,iblIrradiance:t,reflectedLight:n}){if(this.sheen===!0&&this.sheenSpecularIndirect.addAssign(t.mul(Ws,gw({normal:Rt,viewDir:Tt,roughness:vu}))),this.clearcoat===!0){const l=Xs.dot(Tt).clamp(),u=Fm({dotNV:l,specularColor:Bc,specularF90:Vc,roughness:ia});this.clearcoatSpecularIndirect.addAssign(this.clearcoatRadiance.mul(u))}const s=q().temp("singleScattering"),r=q().temp("multiScattering"),o=t.mul(1/Math.PI);this.computeMultiscattering(s,r,sa);const a=s.add(r),c=_t.mul(a.r.max(a.g).max(a.b).oneMinus());n.indirectSpecular.addAssign(e.mul(s)),n.indirectSpecular.addAssign(r.mul(o)),n.indirectDiffuse.addAssign(c.mul(o))}ambientOcclusion({ambientOcclusion:e,reflectedLight:t}){const s=Rt.dot(Tt).clamp().add(e),r=Si.mul(-16).oneMinus().negate().exp2(),o=e.sub(s.pow(r).oneMinus()).clamp();this.clearcoat===!0&&this.clearcoatSpecularIndirect.mulAssign(e),this.sheen===!0&&this.sheenSpecularIndirect.mulAssign(e),t.indirectDiffuse.mulAssign(e),t.indirectSpecular.mulAssign(o)}finish(e){const{outgoingLight:t}=e;if(this.clearcoat===!0){const n=Xs.dot(Tt).clamp(),s=kr({dotVH:n,f0:Bc,f90:Vc}),r=t.mul(Tl.mul(s).oneMinus()).add(this.clearcoatSpecularDirect.add(this.clearcoatSpecularIndirect).mul(Tl));t.assign(r)}if(this.sheen===!0){const n=Ws.r.max(Ws.g).max(Ws.b).mul(.157).oneMinus(),s=t.mul(n).add(this.sheenSpecularDirect,this.sheenSpecularIndirect);t.assign(s)}}}const _w=new cu;class zm extends ln{constructor(e){super(),this.isMeshStandardNodeMaterial=!0,this.emissiveNode=null,this.metalnessNode=null,this.roughnessNode=null,this.setDefaultValues(_w),this.setValues(e)}setupLightingModel(){return new Lu}setupSpecular(){const e=Ft(q(.04),_t.rgb,na);bn.assign(e),sa.assign(1)}setupVariants(){const e=this.metalnessNode?Z(this.metalnessNode):iE;na.assign(e);let t=this.roughnessNode?Z(this.roughnessNode):nE;t=Um({roughness:t}),Si.assign(t),this.setupSpecular(),_t.assign(Me(_t.rgb.mul(e.oneMinus()),_t.a))}copy(e){return this.emissiveNode=e.emissiveNode,this.metalnessNode=e.metalnessNode,this.roughnessNode=e.roughnessNode,super.copy(e)}}qt("MeshStandardNodeMaterial",zm);const xw=new EM;class Bm extends zm{constructor(e){super(),this.isMeshPhysicalNodeMaterial=!0,this.clearcoatNode=null,this.clearcoatRoughnessNode=null,this.clearcoatNormalNode=null,this.sheenNode=null,this.sheenRoughnessNode=null,this.iridescenceNode=null,this.iridescenceIORNode=null,this.iridescenceThicknessNode=null,this.specularIntensityNode=null,this.specularColorNode=null,this.iorNode=null,this.transmissionNode=null,this.thicknessNode=null,this.attenuationDistanceNode=null,this.attenuationColorNode=null,this.dispersionNode=null,this.anisotropyNode=null,this.setDefaultValues(xw),this.setValues(e)}get useClearcoat(){return this.clearcoat>0||this.clearcoatNode!==null}get useIridescence(){return this.iridescence>0||this.iridescenceNode!==null}get useSheen(){return this.sheen>0||this.sheenNode!==null}get useAnisotropy(){return this.anisotropy>0||this.anisotropyNode!==null}get useTransmission(){return this.transmission>0||this.transmissionNode!==null}get useDispersion(){return this.dispersion>0||this.dispersionNode!==null}setupSpecular(){const e=this.iorNode?Z(this.iorNode):_E;Wo.assign(e),bn.assign(Ft(Ti(ip(Wo.sub(1).div(Wo.add(1))).mul(eE),q(1)).mul(td),_t.rgb,na)),sa.assign(Ft(td,1,na))}setupLightingModel(){return new Lu(this.useClearcoat,this.useSheen,this.useIridescence,this.useAnisotropy,this.useTransmission,this.useDispersion)}setupVariants(e){if(super.setupVariants(e),this.useClearcoat){const t=this.clearcoatNode?Z(this.clearcoatNode):rE,n=this.clearcoatRoughnessNode?Z(this.clearcoatRoughnessNode):oE;Tl.assign(t),ia.assign(Um({roughness:n}))}if(this.useSheen){const t=this.sheenNode?q(this.sheenNode):lE,n=this.sheenRoughnessNode?Z(this.sheenRoughnessNode):uE;Ws.assign(t),vu.assign(n)}if(this.useIridescence){const t=this.iridescenceNode?Z(this.iridescenceNode):dE,n=this.iridescenceIORNode?Z(this.iridescenceIORNode):fE,s=this.iridescenceThicknessNode?Z(this.iridescenceThicknessNode):pE;yu.assign(t),Wf.assign(n),Xf.assign(s)}if(this.useAnisotropy){const t=(this.anisotropyNode?se(this.anisotropyNode):hE).toVar();as.assign(t.length()),Lt(as.equal(0),()=>{t.assign(se(1,0))}).else(()=>{t.divAssign(se(as)),as.assign(as.saturate())}),El.assign(as.pow2().mix(Si.pow2(),1)),Go.assign(qs[0].mul(t.x).add(qs[1].mul(t.y))),Zs.assign(qs[1].mul(t.x).sub(qs[0].mul(t.y)))}if(this.useTransmission){const t=this.transmissionNode?Z(this.transmissionNode):mE,n=this.thicknessNode?Z(this.thicknessNode):gE,s=this.attenuationDistanceNode?Z(this.attenuationDistanceNode):xE,r=this.attenuationColorNode?q(this.attenuationColorNode):vE;if(Al.assign(t),qf.assign(n),Yf.assign(s),$f.assign(r),this.useDispersion){const o=this.dispersionNode?Z(this.dispersionNode):ME;jf.assign(o)}}}setupNormal(e){super.setupNormal(e);const t=this.clearcoatNormalNode?q(this.clearcoatNormalNode):aE;Xs.assign(t)}copy(e){return this.clearcoatNode=e.clearcoatNode,this.clearcoatRoughnessNode=e.clearcoatRoughnessNode,this.clearcoatNormalNode=e.clearcoatNormalNode,this.sheenNode=e.sheenNode,this.sheenRoughnessNode=e.sheenRoughnessNode,this.iridescenceNode=e.iridescenceNode,this.iridescenceIORNode=e.iridescenceIORNode,this.iridescenceThicknessNode=e.iridescenceThicknessNode,this.specularIntensityNode=e.specularIntensityNode,this.specularColorNode=e.specularColorNode,this.transmissionNode=e.transmissionNode,this.thicknessNode=e.thicknessNode,this.attenuationDistanceNode=e.attenuationDistanceNode,this.attenuationColorNode=e.attenuationColorNode,this.dispersionNode=e.dispersionNode,this.anisotropyNode=e.anisotropyNode,super.copy(e)}}qt("MeshPhysicalNodeMaterial",Bm);class vw extends Lu{constructor(e,t,n,s){super(e,t,n),this.useSSS=s}direct({lightDirection:e,lightColor:t,reflectedLight:n},s,r){if(this.useSSS===!0){const o=r.material,{thicknessColorNode:a,thicknessDistortionNode:c,thicknessAmbientNode:l,thicknessAttenuationNode:u,thicknessPowerNode:d,thicknessScaleNode:h}=o,p=e.add(Rt.mul(c)).normalize(),g=Z(Tt.dot(p.negate()).saturate().pow(d).mul(h)),_=q(g.add(l).mul(a));n.directDiffuse.addAssign(_.mul(u.mul(t)))}super.direct({lightDirection:e,lightColor:t,reflectedLight:n},s,r)}}class yw extends Bm{constructor(e){super(e),this.thicknessColorNode=null,this.thicknessDistortionNode=Z(.1),this.thicknessAmbientNode=Z(0),this.thicknessAttenuationNode=Z(.1),this.thicknessPowerNode=Z(2),this.thicknessScaleNode=Z(10)}get useSSS(){return this.thicknessColorNode!==null}setupLightingModel(){return new vw(this.useClearcoat,this.useSheen,this.useIridescence,this.useSSS)}copy(e){return this.thicknessColorNode=e.thicknessColorNode,this.thicknessDistortionNode=e.thicknessDistortionNode,this.thicknessAmbientNode=e.thicknessAmbientNode,this.thicknessAttenuationNode=e.thicknessAttenuationNode,this.thicknessPowerNode=e.thicknessPowerNode,this.thicknessScaleNode=e.thicknessScaleNode,super.copy(e)}}qt("MeshSSSNodeMaterial",yw);const Mw=he(({normal:i,lightDirection:e,builder:t})=>{const n=i.dot(e),s=se(n.mul(.5).add(.5),0);if(t.material.gradientMap){const r=Ni("gradientMap","texture").context({getUV:()=>s});return q(r.r)}else{const r=s.fwidth().mul(.5);return Ft(q(.7),q(1),li(Z(.7).sub(r.x),Z(.7).add(r.x),s.x))}});class Sw extends ba{direct({lightDirection:e,lightColor:t,reflectedLight:n},s,r){const o=Mw({normal:aa,lightDirection:e,builder:r}).mul(t);n.directDiffuse.addAssign(o.mul(lr({diffuseColor:_t.rgb})))}indirectDiffuse({irradiance:e,reflectedLight:t}){t.indirectDiffuse.addAssign(e.mul(lr({diffuseColor:_t})))}}const Tw=new NM;class Ew extends ln{constructor(e){super(),this.isMeshToonNodeMaterial=!0,this.lights=!0,this.setDefaultValues(Tw),this.setValues(e)}setupLightingModel(){return new Sw}}qt("MeshToonNodeMaterial",Ew);const Nw=new bM;class Aw extends ln{constructor(e){super(),this.lights=!1,this.isMeshMatcapNodeMaterial=!0,this.setDefaultValues(Nw),this.setValues(e)}setupVariants(e){const t=cN;let n;e.material.matcap?n=Ni("matcap","texture").context({getUV:()=>t}):n=q(Ft(.2,.8,t.y)),_t.rgb.mulAssign(n.rgb)}}qt("MeshMatcapNodeMaterial",Aw);const ww=new Tf;class bw extends ln{constructor(e){super(),this.isPointsNodeMaterial=!0,this.lights=!1,this.normals=!1,this.transparent=!0,this.sizeNode=null,this.setDefaultValues(ww),this.setValues(e)}copy(e){return this.sizeNode=e.sizeNode,super.copy(e)}}qt("PointsNodeMaterial",bw);const Rw=new MM;class Cw extends ln{constructor(e){super(),this.isSpriteNodeMaterial=!0,this.lights=!1,this.normals=!1,this.positionNode=null,this.rotationNode=null,this.scaleNode=null,this.setDefaultValues(Rw),this.setValues(e)}setupPosition({object:e,context:t}){const{positionNode:n,rotationNode:s,scaleNode:r}=this,o=Jt;let a=ms.mul(q(n||0)),c=se(Br[0].xyz.length(),Br[1].xyz.length());r!==null&&(c=c.mul(r));let l=o.xy;e.center&&e.center.isVector2===!0&&(l=l.sub(ze(e.center).sub(.5))),l=l.mul(c);const u=Z(s||cE),d=l.rotate(u);a=Me(a.xy.add(d),a.zw);const h=si.mul(a);return t.vertex=o,h}copy(e){return this.positionNode=e.positionNode,this.rotationNode=e.rotationNode,this.scaleNode=e.scaleNode,super.copy(e)}}qt("SpriteNodeMaterial",Cw);class Lw extends ba{constructor(){super(),this.shadowNode=Z(1).toVar("shadowMask")}direct({shadowMask:e}){this.shadowNode.mulAssign(e)}finish(e){_t.a.mulAssign(this.shadowNode.oneMinus()),e.outgoingLight.rgb.assign(_t.rgb)}}const Pw=new TM;class Iw extends ln{constructor(e){super(),this.isShadowNodeMaterial=!0,this.lights=!0,this.setDefaultValues(Pw),this.setValues(e)}setupLightingModel(){return new Lw}}qt("ShadowNodeMaterial",Iw);class Dw extends ln{constructor(e={}){super(),this.normals=!1,this.lights=!1,this.isVolumeNodeMaterial=!0,this.testNode=null,this.setValues(e)}setup(e){const t=TN(this.map,null,0),n=he(({orig:s,dir:r})=>{const o=q(-.5),a=q(.5),c=r.reciprocal(),l=o.sub(s).mul(c),u=a.sub(s).mul(c),d=Ti(l,u),h=fn(l,u),p=fn(d.x,fn(d.y,d.z)),g=Ti(h.x,Ti(h.y,h.z));return se(p,g)});this.fragmentNode=he(()=>{const s=Ot(q($T.mul(Me(hp,1)))),o=Ot(dn.sub(s)).normalize(),a=Et("vec2","bounds").assign(n({orig:s,dir:o}));a.x.greaterThan(a.y).discard(),a.assign(se(fn(a.x,0),a.y));const c=Et("vec3","p").assign(s.add(a.x.mul(o))),l=Et("vec3","inc").assign(q(o.abs().reciprocal())),u=Et("float","delta").assign(Ti(l.x,Ti(l.y,l.z)));u.divAssign(Ni("steps","float"));const d=Et("vec4","ac").assign(Me(Ni("base","color"),0));return Kn({type:"float",start:a.x,end:a.y,update:"+= delta"},()=>{const h=Et("float","d").assign(t.uv(c.add(.5)).r);this.testNode!==null?this.testNode({map:t,mapValue:h,probe:c,finalColor:d}).append():(d.a.assign(1),Np()),c.addAssign(o.mul(u))}),d.a.equal(0).discard(),Me(d)})(),super.setup(e)}}qt("VolumeNodeMaterial",Dw);const Ms=new yM,Ba=new gn(10,window.innerWidth/window.innerHeight,.1,1e3),_r=new vM({canvas:document.querySelector("#bg"),antialias:!0});_r.setPixelRatio(window.devicePixelRatio);_r.setSize(window.innerWidth,window.innerHeight);_r.shadowMapSoft=!0;Ba.position.setZ(30);const Uw=new Ma(10,200,200,0,Math.PI*2,0,Math.PI),Ow=new Sa().load(GM),Rd=new Sa().load(WM),Fw=new Sa().load(XM),zw=new Nf({map:Ow,bumpMap:Rd,bumpScale:50,specularMap:Fw,shininess:100,displacementMap:Rd,displacementScale:.05}),Vm=new Cn(Uw,zw);Ms.add(Vm);const Bw=new Ma(10.07,200,200,0,Math.PI*2,0,Math.PI),Vw=new Sa().load(qM),Hw=new cu({color:16777215,alphaMap:Vw,blending:Hc}),Hm=new Cn(Bw,Hw);Ms.add(Hm);const km=new bf(16777215,2),kw=new Rf(268435455,.02);km.position.set(5,10,7.5);const ha=new L(0,1,0);new BM(ha);const Cd=Math.PI/3650;Ms.add(kw);Ms.add(km);Ms.add(ha);const Gw=new HM(Ba,_r.domElement);_r.render(Ms,Ba);function Gm(){requestAnimationFrame(Gm),Vm.rotateOnAxis(ha,Cd),Hm.rotateOnAxis(ha,Cd*.9),_r.render(Ms,Ba),Gw.update()}Gm();
