                        ...
                        <NavigationMenuItem className="w-full">
                            ...
                            >
                                <div className=" h-fit justify-center">
                                    <Github fill={githubColor} className={headerItemIconStyle}></Github>
                                </div>
                            </NavigationMenuLink>
                        </NavigationMenuItem>
                        <NavigationMenuItem className="w-full">
                            <NavigationMenuLink
                                ...
                                <div className=" h-fit justify-center">
                                    <LinkedIn fill={linkedInColor} className={headerItemIconStyle}></LinkedIn>
                                </div>
                            </NavigationMenuLink>
                        </NavigationMenuItem>
                        <NavigationMenuItem className="w-full">
                            <NavigationMenuLink
                                ...
                                <div className=" h-fit justify-center">
                                    <Behance fill={behanceColor} className={headerItemIconStyle}></Behance>
                                </div>
                            </NavigationMenuLink>
                        </NavigationMenuItem>
                    </NavigationMenuList>
